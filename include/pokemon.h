...
#define TM01_POWER_PUNCH (1 << 0)
#define TM02_DRACHENKLAUE (1 << 1)
#define TM03_AQUAWELLE (1 << 2)
#define TM04_GEDANKENGUT (1 << 3)
#define TM05_BRUELLER (1 << 4)
#define TM06_TOXIN (1 << 5)
#define TM07_HAGELSTURM (1 << 6)
#define TM08_PROTZER (1 << 7)
#define TM09_KUGELSAAT (1 << 0)
#define TM10_KRAFTRESERVE (1 << 1)
#define TM11_SONNENTAG (1 << 2)
#define TM12_VERHOEHNER (1 << 3)
#define TM13_EISSTRAHL (1 << 4)
#define TM14_BLIZZARD (1 << 5)
#define TM15_HYPERSTRAHL (1 << 6)
#define TM16_LICHTSCHILD (1 << 7)
#define TM17_SCHUTZSCHILD (1 << 0)
#define TM18_REGENTANZ (1 << 1)
#define TM19_GIGASAUGER (1 << 2)
#define TM20_BODYGUARD (1 << 3)
#define TM21_FRUSTRATION (1 << 4)
#define TM22_SOLARSTRAHL (1 << 5)
#define TM23_EISENSCHWEIF (1 << 6)
#define TM24_DONNERBLITZ (1 << 7)
#define TM25_DONNER (1 << 0)
#define TM26_ERDBEBEN (1 << 1)
#define TM27_RUECKKEHR (1 << 2)
#define TM28_SCHAUFLER (1 << 3)
#define TM29_PSYCHOKINESE (1 << 4)
#define TM30_SPUKBALL (1 << 5)
#define TM31_DURCHBRUCH (1 << 6)
#define TM32_DOPPELTEAM (1 << 7)
#define TM33_REFLEKTOR (1 << 0)
#define TM34_SCHOCKWELLE (1 << 1)
#define TM35_FLAMMENWURF (1 << 2)
#define TM36_MATSCHBOMBE (1 << 3)
#define TM37_SANDSTURM (1 << 4)
#define TM38_FEUERSTURM (1 << 5)
#define TM39_FELSGRAB (1 << 6)
#define TM40_AERO_ASS (1 << 7)
#define TM41_FOLTERKNECHT (1 << 0)
#define TM42_FASSADE (1 << 1)
#define TM43_GEHEIMPOWER (1 << 2)
#define TM44_ERHOLUNG (1 << 3)
#define TM45_ANZIEHUNG (1 << 4)
#define TM46_RAUB (1 << 5)
#define TM47_STAHLFLUEGEL (1 << 6)
#define TM48_WERTEWECHSEL (1 << 7)
#define TM49_UEBERNAHME (1 << 0)
#define TM50_HITZEKOLLER (1 << 1)
#define VM01_ZERSCHNEIDER (1 << 2)
#define VM02_FLIEGEN (1 << 3)
#define VM03_SURFER (1 << 4)
#define VM04_STAERKE (1 << 5)
#define VM05_BLITZ (1 << 6)
#define VM06_ZERTRUEMMERER (1 << 7)
#define VM07_KASKADE (1 << 0)
#define VM08_TAUCHER (1 << 1)
