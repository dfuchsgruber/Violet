...
mov_take_pokemon:
    .byte PAUSE_16, PAUSE_16, LOOK_RIGHT, PAUSE_16, PAUSE_16, LOOK_LEFT, PAUSE_16, PAUSE_16, PAUSE_16, LOOK_UP, STEP_UP_VERY_SLOW
    .byte HIDE_SPRITE, PAUSE_16, PAUSE_16, PAUSE_16, PAUSE_16, 0, SHOW_SPRITE, STEP_DOWN_VERY_SLOW, STOP