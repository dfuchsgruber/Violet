...
.global ow_script_ceometria_gym_punishment_room_door
.global ow_script_ceometria_gym_warp_to_gym_leader

ow_script_ceometria_gym_punishment_room_door:
@ // Step 1
    ...
    special SPECIAL_MAP_UPDATE_BLOCKS
    pause 32
    special2 LASTRESULT SPECIAL_CEOMETRIA_GYM_GET_NUMBER_WAITING_ROOMS
    compare LASTRESULT 13
    gotoif HIGHER_OR_EQUAL ow_script_ceometria_gym_warp_to_gym_leader
    warpmuted 19 6 0 255 255
    waitstate
    end 

ow_script_ceometria_gym_warp_to_gym_leader:
    warpmuted 19 8 0 255 255
    waitstate
    end
