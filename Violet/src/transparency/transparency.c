...
u16 transparency_disabling_special_ids [] = {0xF9, 0x190, 0xFD, 0xFE, 0x9F, 0x2B, 0x2C, SPECIAL_DAYCARE_SELECT_PARTY_POKEMON,
    SPECIAL_MOVE_TUTOR_SELECT_POKEMON, 0xFFFF};
