...
str_trainer0_challange:
    .autostring 34 2 "Silvania ist kein Ort für hartgesottene Gemüter wie mich!\pIch sehne mich nach roher Schlagkraft!"
str_trainer0_defeat:
    .autostring 34 2 "Soll das bedeuten, dass ich nicht Manns genug bin?"
.elseif LANG_EN
str_trainer0_challange:
    .autostring 34 2 "Silvania is no place for hardboiled spirits like mine!\pI crave raw force!"
str_trainer0_defeat:
