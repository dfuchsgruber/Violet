...
.global ow_script_aschhain_lavados

ow_script_aschhain_lavados:
    lockall
    ...
    hidesprite 9
    setvar ASCHHAIN_LAVADOS_VAR 0x1
...
move_down_with_flap_sound:
    ...
    applymovement 9 mov_step_down_very_slow
    waitmovement 0x0
    return
...
.ifdef LANG_GER
str_growl_0:
    .autostring 34 2 "Gyaaaaah!"
str_growl_1:
    .autostring 34 2 "Gyaah! Gyaaaaaah!"
.elseif LANG_EN
.endif
