...
wild_pokemon_entry wild_pokemon_route_2_clouds_grass_entries[12] = {
	...
	[WILD_POKEMON_DENSITY_GRASS_11_1_PERCENT] = 
		{.level_min = 28, .level_max = 32, .species = POKEMON_STARAVIA},
};

wild_pokemon_habitat wild_pokemon_route_2_clouds_grass = {
	.frequency = 2, .data = wild_pokemon_route_2_clouds_grass_entries
};


wild_pokemon_entry wild_pokemon_route_2_clouds_water_entries[5] = {
	...
	[WILD_POKEMON_DENSITY_WATER_2_5_PERCENT] = 
		{.level_min = 25, .level_max = 30, .species = POKEMON_KRAMURX},
	[WILD_POKEMON_DENSITY_WATER_3_4_PERCENT] = 
		{.level_min = 30, .level_max = 35, .species = POKEMON_KRAMURX},
...
wild_pokemon_entry wild_pokemon_route_2_clouds_rod_entries[10] = {
