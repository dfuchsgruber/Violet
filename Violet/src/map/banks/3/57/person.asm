...
.ifdef LANG_GER
str_rival_outside:
	.autostring 34 2 "PLAYER!\pJetzt kommt es darauf an!\pIch werde alle Arenaleiter in Theto schlagen und zum größten Trainer aller Zeiten werden!\pUnd du kannst meinen Staub fressen!"
str_felix_outside:
	.autostring 34 2 "Ich kann gar nicht glauben, dass wir morgen schon nicht mehr hierher zurückkommen.\pWas kommt nun auf uns zu?\pIch will Opi nicht enttäuschen.\pAls Trainer will ich deshalb alles dafür geben, den Menschen in dieser Region zu helfen!"
str_may_outside:
	.autostring 34 2 "I-Ich bin so nervösDOTS\pIch hätte niemals gedacht, dass ich diese Prüfung bestehen könnte.\pAber die Herausforderung, die jetzt vor uns liegt, ist noch viel größer.\pIch hoffe, dass ich ihr gewachsen bin.\pIch will wirklich ein guter Trainer werden, das verstehst du doch, PLAYER, oder?"
.elseif LANG_EN
str_rival_outside:
	.autostring 34 2 "PLAYER!\pNow it's time to prove ourselves!\pI will defeat all Gym Leaders in Theto and become the greatest Trainer of all time!\pAnd you can eat my dust!"
str_felix_outside:
	.autostring 34 2 "I can't believe that tomorrow we won't be coming back here.\pWhat lies ahead of us?\pI don't want to disappoint Mr. Faun.\pAs a Trainer I will do everything I can to help the people in this region!"
str_may_outside:
	.autostring 34 2 "I-I am so nervousDOTS\pI never thought I would be able to pass this exam.\pBut the challenge that lies ahead of us is even greater.\pI hope I will be able to face it.\pI really want to become a good Trainer, you understand that, right PLAYER?"
.endif
...
.ifdef LANG_GER
str_0:
	.autostring 34 2 "Mami sagt, dass ich eines Tages auch auf diese Trainerschule gehen werde.\pIch bin ja schon so aufgeregt!"
str_1:
...
.elseif LANG_EN
str_0:
	.autostring 34 2 "My mom says that one day I will also go to this Trainer School.\pI am so excited already!"
str_1:
	.autostring 34 2 "My daughter dreams of going to this school.\pAnd because the headmaster is such a renowned Trainer, I think it would be a good choice."
str_2:
	.autostring 34 2 "PhewDOTS\pI had a fight with one of my classmates during the break.\pAnd when we wanted to settle our dispute with a battle, I got scared and ran awayDOTS"
.endif
