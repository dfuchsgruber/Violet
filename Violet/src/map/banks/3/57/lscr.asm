...
lscr_movesprites:
	.hword TRAINERSCHOOL_PROGRESS, 4
...
ow_script_trainerschool_movesprites:
	movesprite PERSON_MAY 45 18
	spritebehave PERSON_MAY BEHAVIOUR_LOOK_AROUND
	movesprite PERSON_FELIX 46 18
	spritebehave PERSON_FELIX BEHAVIOUR_LOOK_AROUND
	movesprite PERSON_RIVAL 48 18
	spritebehave PERSON_RIVAL BEHAVIOUR_LOOK_AROUND
	end
