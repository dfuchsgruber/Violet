...
str_teah_7:
    .autostring 34 2 "You are the child that defeated Rin in the Kranzdorf-Forest?\pIs it true that you fought a battle against the legendary Pokémon Groudon?\pHow strange that I have not foressen your arrival."
str_narcissa_6:
