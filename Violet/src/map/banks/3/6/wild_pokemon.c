...
wild_pokemon_entry wild_pokemon_3_6_water_entries[5] = {
	[WILD_POKEMON_DENSITY_WATER_0_60_PERCENT] = 
		{.level_min = 5, .level_max = 10, .species = POKEMON_ENTON},
	[WILD_POKEMON_DENSITY_WATER_1_30_PERCENT] = 
		{.level_min = 10, .level_max = 20, .species = POKEMON_ENTON},
...
wild_pokemon_habitat wild_pokemon_3_6_water = {
	.frequency = 1, .data = wild_pokemon_3_6_water_entries
};

wild_pokemon_entry wild_pokemon_3_6_rod_entries[10] = {
	...
	[WILD_POKEMON_DENSITY_SUPER_ROD_4_1_PERCENT] = 
		{.level_min = 30, .level_max = 40, .species = POKEMON_GARADOS},
};
