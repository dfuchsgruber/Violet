...
void map_orina_city_wanted_posters() {
    ...
    scroll_indicator_template indicator_template = {
        .arrow0_type = SCROLL_ARROW_UP, .arrow0_x = 8 + (9 * 8 / 2), .arrow0_y = 8,
        .arrow1_type = SCROLL_ARROW_DOWN, .arrow1_x = 8 + (9 * 8 / 2), .arrow1_y = (u8)(8 + 16 * gp_list_menu_template.max_items_showed),
        .arrow0_threshold = 0, 
