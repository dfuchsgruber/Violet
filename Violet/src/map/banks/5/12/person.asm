...
.ifdef LANG_GER
str_0:
    .autostring 34 2 "Als meine Schwiegereltern hier eingezogen sind, hatte ich ja zunächst recht große BedenkenDOTS\pDOTS DOTS DOTS\nDOTS DOTS DOTS\pNein, meine Meinung hat sich seitdem nicht gendertDOTS"
str_1:
    .autostring 34 2 "Früher haben meine Eltern in Bruchfels gelebt.\pAber weil bei dem großen Unglück vor einigen Jahren deren Haus vollkommen zerstört wurde, sind sie bei meinem Mann und mir eingezogen.\pIch werde den Eindruck nicht los, dass er davon nicht allzu begeistert istDOTS"
str_2:
...
str_3:
    .autostring 34 2 "Trotz unseres hohen Alters sind mein Mann und ich aus Bruchfels zu unserer Tochter hierher gezogen.\pVon Zeit zu Zeit fehlt mir die salzige Luft aber schon.\pDafür kann man hier in Blütenbach die wunderschönen Kirschbäume betrachten."
str_4:
...
str_1:
    .autostring 34 2 "My parents used to live in Bruchfels.\pBut ever since the big catastrophy there destroyed their home they moved in with me and my husband.\pI just have a feeling that he doesn't really like having my parents arroundDOTS"
str_2:
...
str_3:
    .autostring 34 2 "Regardless of our high age I and my husband moved in with my daughter.\pFrom time to time I really miss the salty air of Bruchfels.\pIn return, here in Petal Creek you have those beautiful cherry trees to watch."
str_4:
