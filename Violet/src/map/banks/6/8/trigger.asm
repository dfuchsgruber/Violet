...
ow_script_bruchfels_gym_puzzle_room_1_open_door:
    setmaptile 0x7 0x1 0x28e 1
    setmaptile 0x7 0x2 0x296 1
    setmaptile 0x8 0x1 0x28f 1
    setmaptile 0x8 0x2 0x297 0
    setmaptile 0x9 0x1 0x288 1
    setmaptile 0x9 0x2 0x290 1
    return
