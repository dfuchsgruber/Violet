...
wild_pokemon_entry wild_pokemon_17_2_grass_entries[12] = {
	...
	[WILD_POKEMON_DENSITY_GRASS_10_1_PERCENT] = 
		{.level_min = 27, .level_max = 29, .species = POKEMON_WABLU},
...
wild_pokemon_habitat wild_pokemon_17_2_grass = {
	.frequency = 2, .data = wild_pokemon_17_2_grass_entries
};

wild_pokemon_data wild_pokemon_17_2 = {
	.bank = 17, .map = 2,
