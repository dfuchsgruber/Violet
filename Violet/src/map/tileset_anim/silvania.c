...
static graphic hydro_pump_graphic = {
    .sprite = gfx_silvania_forest_hydro_pumpsTiles,
    .tag = SILVANIA_FOREST_HYDRO_PUMP_TAG,
    .size = 3 * GRAPHIC_SIZE_4BPP(16, 32),
};
...
static oam_template hydro_pump_template = {
    .tiles_tag = SILVANIA_FOREST_HYDRO_PUMP_TAG,
    .pal_tag = SILVANIA_FOREST_HYDRO_PUMP_TAG,
...
tileset_animation tileset_silvania_animations[] = {
    {.cycle = 6, .speed = 8, .start_tile = 0x282, .num_tiles = 4 * 3, .gfx = gfx_maptileset_silvania_animation_sparklesTiles},
    {.cycle = 6, .speed = 8, .start_tile = 0x298, .num_tiles = 4, .gfx = gfx_maptileset_silvania_animation_fireTiles},
};
