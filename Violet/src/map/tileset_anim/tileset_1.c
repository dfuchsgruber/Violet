...
extern const u16 gfx_tileset_1_anim_waterTiles[];

static const tileset_animation tileset_1_animations[] = {
    {
        .cycle = 5, .speed = 16, .start_tile = 0x3b2, .num_tiles = 10, .gfx = gfx_tileset_1_anim_waterTiles,
    },
};

static const tileset_animation_header tileset_1_animations_head = {
