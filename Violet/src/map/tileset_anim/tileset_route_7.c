...
extern const u16 gfx_tileset_route_7_anim_fireTiles[];

static const tileset_animation tileset_route_7_animations[] = {
    {
		.cycle = 4, .speed = 16, .start_tile = 0x37A, .num_tiles = 4,
		.gfx = gfx_tileset_route_7_anim_fireTiles
    }
};
