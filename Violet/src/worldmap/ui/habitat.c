...
extern LZ77COMPRESSED gfx_worldmap_ui_habitat_frameTiles;
extern LZ77COMPRESSED gfx_worldmap_ui_habitat_frameMap;
extern color_t gfx_worldmap_ui_habitat_framePal[16];

extern LZ77COMPRESSED gfx_worldmap_icon_grassTiles;
extern color_t gfx_worldmap_icon_grassPal[16];
extern LZ77COMPRESSED gfx_worldmap_icon_waterTiles;
extern color_t gfx_worldmap_icon_waterPal[16];
extern LZ77COMPRESSED gfx_worldmap_icon_rodTiles;
extern color_t gfx_worldmap_icon_rodPal[16];
extern LZ77COMPRESSED gfx_worldmap_icon_radarTiles;
extern color_t gfx_worldmap_icon_radarPal[16];
extern LZ77COMPRESSED gfx_worldmap_icon_rod_typesTiles;
extern color_t gfx_worldmap_icon_rod_typesPal[16];
extern LZ77COMPRESSED gfx_worldmap_icon_ball_caughtTiles;
extern color_t gfx_worldmap_icon_ball_caughtPal[16];
extern u8 gfx_worldmap_icon_percentageTiles[GRAPHIC_SIZE_4BPP(16, 16 * WORLDMAP_UI_HABITAT_NUM_PERCENTAGES)];
extern color_t gfx_worldmap_icon_percentagePal[16];

static graphic graphic_icon_grass = {
    .sprite = gfx_worldmap_icon_grassTiles, .tag = WORLDMAP_UI_GFX_TAG_ICON_GRASS,
    .size = GRAPHIC_SIZE_4BPP(16, 64)
};

static graphic graphic_icon_water = {
    .sprite = gfx_worldmap_icon_waterTiles, .tag = WORLDMAP_UI_GFX_TAG_ICON_WATER,
    .size = GRAPHIC_SIZE_4BPP(16, 96)
};

static graphic graphic_icon_radar = {
    .sprite = gfx_worldmap_icon_radarTiles, .tag = WORLDMAP_UI_GFX_TAG_ICON_RADAR,
    .size = GRAPHIC_SIZE_4BPP(16, 128)
};

static graphic graphic_icon_rod = {
    .sprite = gfx_worldmap_icon_rodTiles, .tag = WORLDMAP_UI_GFX_TAG_ICON_ROD,
    .size = GRAPHIC_SIZE_4BPP(16, 48)
};

static graphic graphic_icon_rod_types = {
    .sprite = gfx_worldmap_icon_rod_typesTiles, .tag = WORLDMAP_UI_GFX_TAG_ICON_ROD_TYPES,
    .size = GRAPHIC_SIZE_4BPP(8, 24)
};

static graphic graphic_icon_ball_caught = {
    .sprite = gfx_worldmap_icon_ball_caughtTiles, .tag = WORLDMAP_UI_GFX_TAG_ICON_BALL_CAUGHT,
    .size = GRAPHIC_SIZE_4BPP(8, 8)
};

static palette palette_icon_grass = {
    .pal = gfx_worldmap_icon_grassPal, .tag = WORLDMAP_UI_GFX_TAG_ICON_GRASS
};

static palette palette_icon_water = {
    .pal = gfx_worldmap_icon_waterPal, .tag = WORLDMAP_UI_GFX_TAG_ICON_WATER
};

static palette palette_icon_radar = {
    .pal = gfx_worldmap_icon_radarPal, .tag = WORLDMAP_UI_GFX_TAG_ICON_RADAR
};

static palette palette_icon_rod = {
    .pal = gfx_worldmap_icon_rodPal, .tag = WORLDMAP_UI_GFX_TAG_ICON_ROD
};

static palette palette_icon_rod_types = {
    .pal = gfx_worldmap_icon_rod_typesPal, .tag = WORLDMAP_UI_GFX_TAG_ICON_ROD_TYPES
};

static palette palette_icon_ball_caught = {
    .pal = gfx_worldmap_icon_ball_caughtPal, .tag = WORLDMAP_UI_GFX_TAG_ICON_BALL_CAUGHT
};

static palette palette_percentages = {
    .pal = gfx_worldmap_icon_percentagePal, .tag = WORLDMAP_UI_GFX_TAG_PERCENTAGE
};

static sprite oam_icon = {
    .attr0 = ATTR0_SHAPE_SQUARE, .attr1 = ATTR1_SIZE_16_16, .attr2 = ATTR2_PRIO(0),
};

static sprite oam_icon_rod_types = {
    .attr0 = ATTR0_SHAPE_SQUARE, .attr1 = ATTR1_SIZE_8_8, .attr2 = ATTR2_PRIO(0),
};

static sprite oam_icon_species = {
    .attr0 = ATTR0_SHAPE_SQUARE, .attr1 = ATTR1_SIZE_32_32, .attr2 = ATTR2_PRIO(0),
};

static gfx_frame gfx_animation_icon_grass[] = {
    {.data = 0, .duration = 0}, 
...
static gfx_frame *gfx_animations_icon_grass[] = {gfx_animation_icon_grass};

static gfx_frame gfx_animation_icon_water[] = {
    {.data = 0, .duration = 0}, 
...
static gfx_frame *gfx_animations_icon_water[] = {gfx_animation_icon_water};

static gfx_frame gfx_animation_icon_radar[] = {
    {.data = 0, .duration = 0}, 
...
static gfx_frame *gfx_animations_icon_radar[] = {gfx_animation_icon_radar};

static gfx_frame gfx_animation_icon_rod[] = {
    {.data = 0, .duration = 0}, 
...
static gfx_frame *gfx_animations_icon_rod[] = {gfx_animation_icon_rod};

static gfx_frame gfx_animation_icon_rod_type_old_rod[] = {{.data = 0, .duration = 0}, {.data = GFX_ANIM_END}};
static gfx_frame gfx_animation_icon_rod_type_good_rod[] = {{.data = 1, .duration = 0}, {.data = GFX_ANIM_END}};
static gfx_frame gfx_animation_icon_rod_type_super_rod[] = {{.data = 2, .duration = 0}, {.data = GFX_ANIM_END}};

static gfx_frame *gfx_animations_icon_rod_types[] = {
    gfx_animation_icon_rod_type_old_rod, gfx_animation_icon_rod_type_good_rod,
    gfx_animation_icon_rod_type_super_rod,
};

static gfx_frame gfx_animations_icon_species_idle[] = {{.data = 0, .duration = 0}, {.data = GFX_ANIM_END, .duration = 0}};
static gfx_frame gfx_animations_icon_species_active[] = {
    {.data = 0, .duration = 0},
...
static gfx_frame *gfx_animations_icon_species[] = {
    gfx_animations_icon_species_idle, gfx_animations_icon_species_active
};

static gfx_frame gfx_animation_icon_ball_caught_idle[] = {{.data = 0, .duration = 0}, {.data = GFX_ANIM_END, .duration = 0}};
static gfx_frame *gfx_animations_icon_ball_caught[] = {
    gfx_animation_icon_ball_caught_idle,
};

static graphic gfx_table_percentages[WORLDMAP_UI_HABITAT_NUM_PERCENTAGES] = {
...
static gfx_frame gfx_animation_icon_percentage[WORLDMAP_UI_HABITAT_NUM_PERCENTAGES][2] = {
...
static gfx_frame* gfx_animations_percentage[WORLDMAP_UI_HABITAT_NUM_PERCENTAGES] = {
...
static u8 oam_animation_idx_to_percentage[WORLDMAP_UI_HABITAT_NUM_PERCENTAGES] = {
...
static oam_template oam_template_icon_grass = {
...
static oam_template oam_template_icon_water = {
...
static oam_template oam_template_icon_radar = {
...
static oam_template oam_template_icon_rod = {
...
static oam_template oam_template_icon_rod_types = {
...
static oam_template oam_template_icon_species = {
...
static oam_template oam_template_icon_ball_caught = {
...
static oam_template oam_template_icon_percentage = {
...
static bg_config worldmap_ui_bg_configs[] = {
    [0] = { // Text layer on UI
...
static tbox_font_colormap font_colormap_transparent = {.background = 0, .body = 2, .edge = 0};
static tbox_font_colormap font_colormap_non_transparent = {.background = 1, .body = 2, .edge = 0};
static tbox_font_colormap font_colormap_transparent_on_ui = {.background = 0, .body = 1, .edge = 2};
static tbox_font_colormap font_colormap_transparent_footer = {.background = 0, .body = 1, .edge = 0};

static u8 str_header[] = LANGDEP(
    PSTRING("Fundorte v. BUFFER_1"),
    PSTRING("Habitats of BUFFER_1")
);

static u8 str_footer_key_select[] = PSTRING("KEY_SELECT");
static u8 str_footer_key_dpad[] = PSTRING("KEY_DPAD");
static u8 str_footer_key_b[] = PSTRING("KEY_B");

static u8 str_footer_switch_map[] = LANGDEP(
    PSTRING("Wechseln"),
    PSTRING("Switch")
);

static u8 str_footer_move[] = LANGDEP(
    PSTRING("Bewegen"),
    PSTRING("Move")
);

static u8 str_footer_back[] = LANGDEP(
    PSTRING("Zurück"),
    PSTRING("Back")
);

static u8 str_no_habitats[] = LANGDEP(
    PSTRING("Keine Gebiete bekannt"),
    PSTRING("No habitats known")
);

static u8 str_grass[] = LANGDEP(PSTRING("Natur"), PSTRING("Nature"));
static u8 str_water[] = LANGDEP(PSTRING("Wasser"), PSTRING("Water"));
static u8 str_radar[] = LANGDEP(PSTRING("Radar"), PSTRING("Radar"));
static u8 str_rod[] = LANGDEP(PSTRING("Angel"), PSTRING("Rod"));

static u8 *habitat_names[] = {
...
static u8 str_namespace_switch_maps[] = LANGDEP(
...
static u8 str_percent[] = PSTRING("%");
static u8 str_no_percent[] = PSTRING(" ---");
...
void worldmap_ui_habitat_show() {
    fmem.gp_state = malloc_and_clear(sizeof(worldmap_ui_state_t));
