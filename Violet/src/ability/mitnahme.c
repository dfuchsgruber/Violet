...
u16 *mitnahme_pick_item(pokemon *p) {
    ...
    int r = rnd16() % 100;
    if (r < 1)
        return &mitnahme_items[l][0];
    if (r < 2)
        return &mitnahme_items[l][1];
    if (r < 5)
        return &mitnahme_items[l][2];
    if (r < 10)
        return &mitnahme_items[l][3];
    if (r < 20)
        return &mitnahme_items[l][4];
    if (r < 30)
        return &mitnahme_items[l][5];
    if (r < 40)
        return &mitnahme_items[l][6];
    if (r < 60)
        return &mitnahme_items[l][7];
    if (r < 70)
        return &mitnahme_items[l][8];
