...
sprite ev_menu_oam_sprite_semi_transparent = {
    .attr0 = ATTR0_ROTSCALE | ATTR0_MODE_SEMI_TRANSPARENT, .attr1 = ATTR1_SIZE_64_64, .attr2 = ATTR2_PRIO(1)};
...
void ev_menu_load_stat() {
    ...
    if (!is_egg) {
        ...
        } else if (stat_decreased == fmem.ev_menu_state->stat_idx && stat_increased != stat_decreased) {
...
void ev_menu_load_pokemon() {
    ...
    if (is_egg)
        ...
        species = (u16)pokemon_get_attribute(p, ATTRIBUTE_SPECIES, 0);
        ...
        if (!fmem.ev_menu_state->delay) {
            if (super.keys_new.keys.B) {
                ...
                big_callbacks[big_callback_new(
                                  ev_menu_big_callback_update_pokemon, 1)]
                    .params[0] = 0;
            } else if (super.keys_new.keys.up) {
                fmem.ev_menu_state->party_idx = (u8)((fmem.ev_menu_state->party_idx + pokemon_get_number_in_party() - 1) %
                                                     pokemon_get_number_in_party());
                big_callbacks[big_callback_new(
                                  ev_menu_big_callback_update_pokemon, 1)]
                    .params[0] = 0;
...
tboxdata ev_menu_tboxes[EV_MENU_TBOX_COUNT + 1] = {
    ...
    [EV_MENU_TBOX_HEADER] = {.bg_id = 0, .x = 1, .y = 0, .w = 28, .h = 2, .pal = 15, .start_tile = 17},
    [EV_MENU_TBOX_HIDDEN_POWER] = {.bg_id = 0, .x = 1, .y = 14, .w = 9, .h = 2, .pal = 15, .start_tile = 73},
    [EV_MENU_TBOX_HIDDEN_POWER_TYPE] = {.bg_id = 0, .x = 1, .y = 18, .w = 4, .h = 2, .pal = 1, .start_tile = 91},
    [EV_MENU_TBOX_HIDDEN_POWER_STRENGTH] = {.bg_id = 0, .x = 6, .y = 18, .w = 4, .h = 2, .pal = 15, .start_tile = 99},
    [EV_MENU_TBOX_CHART_STATS] = {.bg_id = 2, .x = 10, .y = 4, .w = 20, .h = 10, .pal = 15, .start_tile = 107},
    [EV_MENU_TBOX_IV_CHART_HEADER] = {.bg_id = 0, .x = 11, .y = 2, .w = 8, .h = 2, .pal = 15, .start_tile = 307},
    [EV_MENU_TBOX_EV_CHART_HEADER] = {.bg_id = 0, .x = 21, .y = 2, .w = 9, .h = 2, .pal = 15, .start_tile = 323},
    [EV_MENU_TBOX_TOTAL_EV] = {.bg_id = 0, .x = 23, .y = 15, .w = 6, .h = 2, .pal = 15, .start_tile = 341},
    [EV_MENU_TBOX_CURRENT_STAT_HEADER] = {.bg_id = 0, .x = 10, .y = 15, .w = 10, .h = 2, .pal = 15, .start_tile = 361},
    [EV_MENU_TBOX_CURRENT_IV] = {.bg_id = 0, .x = 14, .y = 17, .w = 2, .h = 3, .pal = 15, .start_tile = 381},
    [EV_MENU_TBOX_CURRENT_EV] = {.bg_id = 0, .x = 23, .y = 17, .w = 10, .h = 3, .pal = 15, .start_tile = 387},
    [EV_MENU_TBOX_HIDDEN_POWER_HEADER] = {.bg_id = 0, .x = 1, .y = 16, .w = 8, .h = 2, .pal = 15, .start_tile = 424},
