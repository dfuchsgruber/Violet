...
mugshot mugshots[] = {
    ...
    [MUGSHOT_RIVAL] = {{
                       ...
                       gfx_mug_rivalPal,
                       str_mug_rival},
    [MUGSHOT_BRIX] = {{[MUGSHOT_NORMAL] = gfx_mug_brixTiles}, gfx_mug_brixPal, str_mug_brix},
    [MUGSHOT_MAY] = {{
    ...
    [MUGSHOT_HIRO] = {{
                      ...
                      gfx_mug_hiroPal,
                      str_mug_hiro},
    [MUGSHOT_LESTER] = {{[MUGSHOT_NORMAL] = gfx_mug_lesterTiles}, gfx_mug_lesterPal, str_mug_lester},
    [MUGSHOT_FAUN] = {{
    ...
    [MUGSHOT_ELISE] = {{
                       ...
                       gfx_mug_elisePal,
                       str_mug_elise},
    [MUGSHOT_EMERYS] = {{[MUGSHOT_NORMAL] = gfx_mug_emerysTiles}, gfx_mug_emerysPal, str_mug_emerys},
    [MUGSHOT_RUBYS] = {{[MUGSHOT_NORMAL] = gfx_mug_rubysTiles}, gfx_mug_rubysPal, str_mug_rubys},
    [MUGSHOT_SAPHIRA] = {{[MUGSHOT_NORMAL] = gfx_mug_saphiraTiles}, gfx_mug_saphiraPal, str_mug_saphira},
    [MUGSHOT_HARRENFELD] = {{[MUGSHOT_NORMAL] = gfx_mug_harrenfeldTiles}, gfx_mug_harrenfeldPal, str_mug_harrenfeld},
    [MUGSHOT_ALBUS] = {{
                       ...
                       gfx_mug_albusPal,
                       str_mug_albus},
    [MUGSHOT_FAUN_YOUNG] = {{[MUGSHOT_NORMAL] = gfx_mug_faun_youngTiles}, gfx_mug_faun_youngPal, str_mug_faun},
    [MUGSHOT_CELEBI] = {{[MUGSHOT_NORMAL] = gfx_pkmn_species_251_pokemon_celebi_frontspriteTiles}, gfx_pkmn_species_251_pokemon_celebi_frontspritePal, str_mug_celebi},
    [MUGSHOT_LARISSA] = {{
    ...
    [MUGSHOT_IGVA] = {{
                      ...
                      gfx_mug_igvaPal,
                      str_mug_igva},
    [MUGSHOT_BLACKBEARD] = {{[MUGSHOT_NORMAL] = gfx_mug_blackbeardTiles, [MUGSHOT_SHOCKED] = gfx_mug_blackbeard_shockedTiles, [MUGSHOT_ANGRY] = gfx_mug_blackbeard_angryTiles, [MUGSHOT_HAPPY] = gfx_mug_blackbeard_happyTiles}, gfx_mug_blackbeardPal, str_mug_blackbeard},
    [MUGSHOT_HIROINE] = {{
                         ...
                         gfx_mug_hiroinePal,
                         str_mug_hiro},
    [MUGSHOT_TEAH] = {{[MUGSHOT_NORMAL] = gfx_mug_teahTiles}, gfx_mug_teahPal, str_mug_teah},
    [MUGSHOT_NARCISSA] = {{[MUGSHOT_NORMAL] = gfx_mug_narcissaTiles}, gfx_mug_narcissaPal, str_mug_narcissa},
    [MUGSHOT_LUCIUS] = {{[MUGSHOT_NORMAL] = gfx_mug_luciusTiles}, gfx_mug_luciusPal, str_mug_lucius},
    [MUGSHOT_LUCKY] = {{[MUGSHOT_NORMAL] = gfx_mug_luckyTiles, [MUGSHOT_SCARED] = gfx_mug_lucky_scaredTiles, [MUGSHOT_SHOCKED] = gfx_mug_lucky_shockedTiles}, gfx_mug_luckyPal, str_mug_lucky},
    [MUGSHOT_LESTER_YOUNG] = {{
                              ...
                              gfx_mug_lester_youngPal,
                              str_mug_lester},
    [MUGSHOT_ROMAN] = {{[MUGSHOT_NORMAL] = gfx_mug_romanTiles, [MUGSHOT_HAPPY] = gfx_mug_roman_happyTiles}, gfx_mug_romanPal, str_mug_roman},
    [MUGSHOT_ROSALIE] = {
        {
...
void mugshot_wait_for_deletion(u8 self) {
    if (big_callback_is_active(mugshot_delete_oam) || big_callback_is_active(mugshot_delete_text))
        return;
