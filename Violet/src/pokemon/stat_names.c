...
const u8 pokemon_stat_name_abbreviated_hp[] = LANGDEP(PSTRING("Kp"), PSTRING("Hp"));
const u8 pokemon_stat_name_abbreviated_attack[] = LANGDEP(PSTRING("Ang."), PSTRING("Atk."));
const u8 pokemon_stat_name_abbreviated_defense[] = LANGDEP(PSTRING("Ver."), PSTRING("Def."));
const u8 pokemon_stat_name_abbreviated_special_attack[] = LANGDEP(PSTRING("S.Ang."), PSTRING("S.Atk."));
const u8 pokemon_stat_name_abbreviated_special_defense[] = LANGDEP(PSTRING("S.Ver."), PSTRING("S.Def."));
const u8 pokemon_stat_name_abbreviated_speed[] = LANGDEP(PSTRING("Init."), PSTRING("Spe."));

const u8 *const pokemon_stat_names_abbreviated[6] = {
