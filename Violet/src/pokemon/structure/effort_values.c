...
u8 potential_ev_attributes[6] = {
    [STAT_HP] = ATTRIBUTE_HP_EV, [STAT_ATTACK] = ATTRIBUTE_ATT_EV, [STAT_DEFENSE] = ATTRIBUTE_DEF_EV, [STAT_SPEED] = ATTRIBUTE_INIT_EV, [STAT_SPECIAL_ATTACK] = ATTRIBUTE_SATT_EV, [STAT_SPECIAL_DEFENSE] = ATTRIBUTE_SDEF_EV};
...
void pokemon_get_evs(pokemon *p, u16 defeated_species) {
    ...
    switch (ball_idx) {
        ...
        case BALL_SPECIAL_ATTACK:
            evs[STAT_SPECIAL_ATTACK]++;
            break;
        case BALL_SPECIAL_DEFENSE:
            evs[STAT_SPECIAL_DEFENSE]++;
            break;
    }
