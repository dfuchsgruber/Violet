...
static const gfx_frame *const gfx_animations_mushroom[1] = {gfx_animation_mushroom_idle};
static const gfx_frame *const gfx_animations_shell[1] = {gfx_animation_shell_idle};
...
static const u32 shell_encounters[] = {[POKEMON_MUSCHAS] = 3, [POKEMON_PERLU] = 2, [POKEMON_KRABBY] = 2, [POKEMON_KREBSCORPS] = 1};
...
static const u32 trash_encounters[] = {[POKEMON_SLEIMA] = 6, [POKEMON_SMOGON] = 5, [POKEMON_ZIGZACHS] = 5, [POKEMON_TEDDIURSA] = 3, [POKEMON_MAMPFAXO] = 1, [POKEMON_PIKACHU] = 3};
