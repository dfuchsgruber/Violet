...
static overworld_sprite ow_tutor_crystals[] = {
    [TYPE_NORMAL] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_NORMAL,
        .unknown = 0x11FF,
        ...
        .gfx_animation = gfx_animations_tutor_crystal,
        .graphics = overworld_tutor_crystal_graphics,
        .rotscale_animation = oam_rotscale_anim_table_null,
    },
    [TYPE_KAMPF] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_KAMPF,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_FLUG] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_FLUG,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_GIFT] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_GIFT,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_BODEN] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_BODEN,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_GESTEIN] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_GESTEIN,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_KAEFER] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_KAEFER,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_GEIST] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_GEIST,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_STAHL] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_STAHL,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_FEE] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_FEE,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_FEUER] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_FEUER,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_WASSER] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_WASSER,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_PFLANZE] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_PFLANZE,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_ELEKTRO] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_ELEKTRO,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_PSYCHO] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_PSYCHO,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_EIS] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_EIS,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_DRACHE] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_DRACHE,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
    ...
    [TYPE_UNLICHT] = {
        .tiles_tag = 0xFFFF,
        .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE + TYPE_UNLICHT,
        .unknown = 0x11FF,
        .size = GRAPHIC_SIZE_4BPP(32, 32),
        .width = 32,
        .height = 32,
