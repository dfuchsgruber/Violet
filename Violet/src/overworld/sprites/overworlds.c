...
static overworld_sprite ow_pokemon_32_32 = {
    .tiles_tag = 0xFFFF,
    .pal_tag = OW_PAL_TAG_POKEMON_BASE,
    .unknown = 0x11FF,
    .size = GRAPHIC_SIZE_4BPP(32, 32),
    .width = 32,
    .height = 32,
    .final_oam = &ow_final_oam_32_32,
    .subsprite_table = &ow_formation_32_32,
    .gfx_animation = ow_anim_standard_npc,
    .graphics = overworld_sprite_lucky,
...
static overworld_sprite ow_pokemon_64_64 = {
    ...
    .width = 64,
    .height = 64,
    .final_oam = &ow_final_oam_64_64,
    .subsprite_table = &ow_formation_64_64,
    .gfx_animation = ow_anim_standard_npc,
    .graphics = NULL,
    .rotscale_animation = oam_rotscale_anim_table_null,
};
...
static overworld_sprite ow_tutor_crystal_dummy = {
    .tiles_tag = 0xFFFF,
    .pal_tag = OW_PAL_TAG_TUTOR_CRYSTAL_BASE,
    .unknown = 0x11FF,
    .size = GRAPHIC_SIZE_4BPP(32, 32),
    .width = 32,
    .height = 32,
...
overworld_sprite ow_mega_stone = {
    ...
    .final_oam = &ow_final_oam_16_16,
    .subsprite_table = &ow_formation_16_16,
    .gfx_animation = gfx_animations_mega_stone,
    .graphics = overworld_gfxs_mega_stone,
    .rotscale_animation = oam_rotscale_anim_table_null,
};

static palette overworld_mega_stone_palette = {
    .pal = gfx_ow_mega_stonePal,
    .tag = OW_PAL_TAG_MEGA_STONE,
};
...
overworld_sprite ow_old_amber = {
    ...
    &ow_final_oam_16_16,
    &ow_formation_16_16,
    ow_anim_standard_npc,
    overworld_sprite_old_amber_sprites,
    oam_rotscale_anim_table_null,
};
...
static overworld_sprite ow_secret_power_vine = {
    .tiles_tag = 0xFFFF,
    .pal_tag = OW_PAL_TAG_SECRET_POWER_VINES,
    .unknown = 0x11FF,
    .size = GRAPHIC_SIZE_4BPP(32, 32),
    .width = 32,
    .height = 32,
    .final_oam = &ow_final_oam_32_32,
    .subsprite_table = &ow_formation_32_32,
    .gfx_animation = gfx_animations_secret_power_vines,
    .graphics = overworld_sprite_secret_power_vines_sprites,
    .rotscale_animation = oam_rotscale_anim_table_null,
};
...
static overworld_sprite ow_secret_power_cave = {
    .tiles_tag = 0xFFFF,
    .pal_tag = OW_PAL_TAG_SECRET_POWER_CAVE,
    .unknown = 0x11FF,
    .size = GRAPHIC_SIZE_4BPP(32, 32),
    .width = 32,
    .height = 32,
    .final_oam = &ow_final_oam_32_32,
    .subsprite_table = &ow_formation_32_32,
    .gfx_animation = gfx_animations_secret_power_cave,
    .graphics = overworld_sprite_secret_power_cave_sprites,
    .rotscale_animation = oam_rotscale_anim_table_null,
};
