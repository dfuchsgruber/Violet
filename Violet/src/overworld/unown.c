...
static oam_template unown_message_oam_templates[UNOWN_MESSAGE_MAX_LEN] = {
    [0] = {
        .tiles_tag = UNOWN_MESSAGE_TAG + 0,
        .pal_tag = UNOWN_MESSAGE_TAG,
        .oam = &unown_message_oam_sprite,
...
void overworld_unown_print_message() {
    ...
    *strbuf = 255;
    ...
    for (int i = 0; i < OVERWORLD_UNOWN_MESSAGE_STATE->message_length; i++) {
        ...
        graphic g = {.sprite = gp_tmp_buf, .tag = (u16)(UNOWN_MESSAGE_TAG + i), .size = GRAPHIC_SIZE_4BPP(64, 64)};
