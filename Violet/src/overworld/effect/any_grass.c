...
any_grass any_grasses[] = {
    {&maptileset0, MB_TALL_GRASS, &overworld_effect_oam_template_high_grass, &overworld_effect_high_grass_pal, any_grass_step, any_grass_player_step_null}, //Normal Grass, behavior 2 triggered by any map
