...
static const gfx_frame frames_scratch[] = {
    {.data = 0, .duration = 0},
    {.data = 0, .duration = 4},
    {.data = 4, .duration = 4},
    {.data = 8, .duration = 4},
...
static const gfx_frame *const animations_scratch[] = {
    frames_scratch,
};

static const gfx_frame frames_lucius_idle[] = {
    {.data = 0, .duration = 0},
    {.data = GFX_ANIM_END},
};


const oam_template ae_animation_ardeal_tower_slash_oam_template = {
...
static const gfx_frame frames_lucius_strike[] = {
    {.data = 0, .duration = 0},
    {.data = 0, .duration = 4},
    {.data = 4, .duration = 4},
    {.data = 8, .duration = 4},
...
static const gfx_frame *const animations_lucius[] = {
    frames_lucius_strike,
    frames_lucius_idle,
};


const oam_template ae_animation_ardeal_tower_lucius_oam_template = {
...
extern const u8 gfx_ardeal_tower_hiro_falling1Tiles[];
extern const u8 gfx_ardeal_tower_hiro_falling1Map[];
extern const u8 gfx_ardeal_tower_hiro_falling2Tiles[];
extern const u8 gfx_ardeal_tower_hiro_falling2Map[];

extern const u8 gfx_ardeal_tower_hiroine_falling1Tiles[];
extern const u8 gfx_ardeal_tower_hiroine_falling1Map[];
extern const u8 gfx_ardeal_tower_hiroine_falling2Tiles[];
extern const u8 gfx_ardeal_tower_hiroine_falling2Map[];
...
void animation_ardeal_tower_falling_bg_animation(u8 self) {
    ...
    *clk = 8;
    const void *tileset_src; const void *tilemap_src;
