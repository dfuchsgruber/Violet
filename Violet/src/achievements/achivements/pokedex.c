...
const achievement_t achievements_pokedex[5] = {
    ...
    {
        .description = (const u8[]) LANGDEP(
            PSTRING("Registriere 20 Pokémon im\nPokédex!"), 
            PSTRING("Register 20 Pokémon in the\nPokédex!")
        ),
    ...
    {
        .description = (const u8[]) LANGDEP(
            PSTRING("Registriere 50 Pokémon im\nPokédex!"), 
            PSTRING("Register 50 Pokémon in the\nPokédex!")
        ),
        .is_achieved = pokedex_catch_50_is_achieved,
        .max_progress = 50,
        .get_progress = pokedex_get_progress,
        .flag_achieved = FLAG_INCREASED_CATCH_RATE,
        .level = ACHIVEMENT_LEVEL_SILVER,
        .reward = {
    ...
    {
        .description = (const u8[]) LANGDEP(
            PSTRING("Registriere 150 Pokémon im\nPokédex!"), 
            PSTRING("Register 50 Pokémon in the\nPokédex!")
        ),
        ...
        .level = ACHIVEMENT_LEVEL_GOLD,
        .reward = {
            .flag = FLAG_POKEDEX_ACHIVEMENT_CATCH_150_REWARD,
            .script = ow_script_achievement_pokedex_catch_150_reward,
            .description = (const u8[]) LANGDEP(
                PSTRING("Seltene wilde Pokémon erscheinen häufiger"), 
                PSTRING("Rare wild Pokémon appear more frequently")
            ),
        }
    },
    {
        .description = (const u8[]) LANGDEP(
            PSTRING("Registriere alle 386 Pokémon\nim Pokédex!"), 
            PSTRING("Register all 386 Pokémon in the\nPokédex!")
        ),
        ...
        .level = ACHIVEMENT_LEVEL_PLATINUM,
    }
};