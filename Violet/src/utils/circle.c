...
const coordinate_t circle_coordinates_radius_0[1] = {
	{0, 0}
};

const coordinate_t circle_coordinates_radius_1[4] = {
	{0, 1}, {-1, 0}, {0, -1}, {1, 0}
};

const coordinate_t circle_coordinates_radius_2[8] = {
	{-1, 1}, {-2, 0}, {0, 2}, {2, 0}, {-1, -1}, {0, -2}, {1, -1}, {1, 1}
};

const coordinate_t circle_coordinates_radius_3[16] = {
	{3, 0}, {2, 1}, {0, 3}, {1, -2}, {1, 2}, {-2, 1}, {-2, -2}, {-2, -1}, {-1, -2}, {2, 2}, {2, -2}, {2, -1}, {-2, 2}, {-1, 2}, {0, -3}, {-3, 0}
};

const coordinate_t circle_coordinates_radius_4[20] = {
	{1, 3}, {-3, -2}, {-3, -1}, {-1, -3}, {-2, -3}, {4, 0}, {2, -3}, {-3, 2}, {1, -3}, {0, 4}, {0, -4}, {3, 2}, {-3, 1}, {2, 3}, {-4, 0}, {-2, 3}, {-1, 3}, {3, 1}, {3, -2}, {3, -1}
};

const coordinate_t circle_coordinates_radius_5[32] = {
...
const coordinate_t circle_coordinates_radius_6[32] = {
...
const circle_coordinates_t circle_coordinates_by_radius[7] = {
