...
trainer trainers[TRAINER_CNT] = {
  ...
  },
  {
    ...
    [0x1e4] = {
        ...
        .encounter_and_gender = {2, 1}, .name = LANGDEP(PSTRING("Annalena"),
            PSTRING("Annalena")), .pokemon_cnt = ARRAY_COUNT(trainer_party_x1e4_dungeon_forest_veteran),
        .ai = TRAINER_AI_NO_EFFECTLESS_OR_NEGATIVE_EFFECTS,
        .party = (trainer_pokemon*) trainer_party_x1e4_dungeon_forest_veteran,
        .uses_custom_moves = true, .uses_custom_items = true,
    },
    [0x1e5] = {
        .trainerclass = TRAINERCLASS_EXPERTE, .sprite = 0x23,
        ...
        .ai = TRAINER_AI_NO_EFFECTLESS_OR_NEGATIVE_EFFECTS,
        .party = (trainer_pokemon*) trainer_party_x1e5_dungeon_forest_veteran,
        .uses_custom_moves = true, .uses_custom_items = true,
    },
    [0x1e6] = {
        .trainerclass = TRAINERCLASS_EXPERTE, .sprite = 0x23,
        ...
        .ai = TRAINER_AI_NO_EFFECTLESS_OR_NEGATIVE_EFFECTS,
        .party = (trainer_pokemon*) trainer_party_x1e6_dungeon_forest_veteran,
        .uses_custom_moves = true, .uses_custom_items = true,
    },
    [0x1e7] = {
        .trainerclass = TRAINERCLASS_EXPERTE, .sprite = 0x23,
        ...
        .ai = TRAINER_AI_NO_EFFECTLESS_OR_NEGATIVE_EFFECTS,
        .party = (trainer_pokemon*) trainer_party_x1e7_dungeon_forest_veteran,
        .uses_custom_moves = true, .uses_custom_items = true,
    },
    [0x1e8] = {
        .trainerclass = TRAINERCLASS_EXPERTE, .sprite = 0x23,
