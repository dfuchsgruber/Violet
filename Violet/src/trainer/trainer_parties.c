...
trainer_pokemon_custom_item_custom_attacks trainer_party_x4c[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 26, POKEMON_NIDOQUEEN, ITEM_GIFTSTICH, ATTACK_GIFTHIEB, ATTACK_SCHAUFLER, ATTACK_DONNERSCHLAG, ATTACK_EISHIEB),
