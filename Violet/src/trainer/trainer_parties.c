...
trainer_pokemon_default_item_default_attacks trainer_party_x1db_power_plant_inside_trainer_0[4] = {
...
trainer_pokemon_default_item_default_attacks trainer_party_x1dc_power_plant_inside_trainer_1[3] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_MAGNETILO),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_FRIZELBLIZ),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,35,POKEMON_MAGNETON),
};

trainer_pokemon_default_item_default_attacks trainer_party_x1dd_power_plant_inside_trainer_2[2] = {
