...
trainer_pokemon_default_item_default_attacks trainer_party_x1a[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,14,POKEMON_MINUN),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,14,POKEMON_PLUSLE)
};
...
trainer_pokemon_custom_item_default_attacks trainer_party_x29[] = {
	TRAINER_PARTY_CUSTOM_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,15,POKEMON_STARALILI,ITEM_TSITRUBEERE),
...
trainer_pokemon_custom_item_default_attacks trainer_party_x43[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,20,POKEMON_IGNIVOR,ITEM_TSITRUBEERE)
};
...
trainer_pokemon_custom_item_default_attacks trainer_party_x44[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,22,POKEMON_SCHLUPPUCK,ITEM_NONE)
};
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x4c[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_SPECIAL_TANK, 0x0, true, false, 24, POKEMON_EVOLI, ITEM_BLENDPUDER, ATTACK_LICHTSCHILD, ATTACK_DOPPELTEAM, ATTACK_REFLEKTOR, ATTACK_FRUSTRATION),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 26, POKEMON_GARADOS, ITEM_TSITRUBEERE, ATTACK_DRACHENTANZ, ATTACK_BISS, ATTACK_NASSSCHWEIF, ATTACK_EISZAHN),
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x5c[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 28, POKEMON_STARAVIA, ITEM_NONE, ATTACK_STAHLFLUEGEL, ATTACK_AERO_ASS, ATTACK_NOTSITUATION, ATTACK_RUCKZUCKHIEB),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 30, POKEMON_SEESKULL, ITEM_TSITRUBEERE, ATTACK_DRACHENTANZ, ATTACK_NASSSCHWEIF, ATTACK_EISENSCHWEIF, ATTACK_GIFTSCHWEIF),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 29, POKEMON_DUFLOR, ITEM_SINELBEERE, ATTACK_SCHLAFPUDER, ATTACK_ENERGIEBALL, ATTACK_MATSCHBOMBE, ATTACK_SYNTHESE)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_x5d[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 28, POKEMON_STARAVIA, ITEM_NONE, ATTACK_STAHLFLUEGEL, ATTACK_AERO_ASS, ATTACK_NOTSITUATION, ATTACK_RUCKZUCKHIEB),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 30, POKEMON_STICHSCHAL, ITEM_TSITRUBEERE, ATTACK_LAUBKLINGE, ATTACK_FLUCH, ATTACK_ZORNKLINGE, ATTACK_GEDULD),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 29, POKEMON_FUKANO, ITEM_NONE, ATTACK_BISS, ATTACK_FEUERZAHN, ATTACK_NAHKAMPF, ATTACK_EISENSCHWEIF)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_x5e[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 28, POKEMON_STARAVIA, ITEM_NONE, ATTACK_STAHLFLUEGEL, ATTACK_AERO_ASS, ATTACK_NOTSITUATION, ATTACK_RUCKZUCKHIEB),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 30, POKEMON_ORTHODOS, ITEM_TSITRUBEERE, ATTACK_FLAMMENRAD, ATTACK_BISS, ATTACK_SCHAUFLER, ATTACK_EISENSCHWEIF),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, 29, POKEMON_TENTACHA, ITEM_NONE, ATTACK_MATSCHBOMBE, ATTACK_AQUAWELLE, ATTACK_ABSCHLAG, ATTACK_AURORASTRAHL)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x6b[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,26,POKEMON_WABLU)
};

trainer_pokemon_default_item_default_attacks trainer_party_x6c[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,25,POKEMON_LEDYBA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,26,POKEMON_LEDIAN)
};

trainer_pokemon_default_item_default_attacks trainer_party_x6d[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,25,POKEMON_KANGAMA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,25,POKEMON_DARTIGNIS),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,26,POKEMON_MASKEREGEN)
};

trainer_pokemon_default_item_default_attacks trainer_party_x6e[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,25,POKEMON_MOGELBAUM),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,23,POKEMON_PAPINELLA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,25,POKEMON_VOLTENSO)
};

trainer_pokemon_default_item_default_attacks trainer_party_x6f[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,26,POKEMON_KAPILZ),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,27,POKEMON_CHEVRUMM)
};

trainer_pokemon_default_item_default_attacks trainer_party_x70[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,29,POKEMON_ELEKTEK)
};

trainer_pokemon_default_item_default_attacks trainer_party_x71[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,27,POKEMON_ULTRIGARIA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,27,POKEMON_GOLBAT),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,28,POKEMON_ENEKORO)
};

trainer_pokemon_default_item_default_attacks trainer_party_x72[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,28,POKEMON_NIDORINA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,27,POKEMON_FLOETTE)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x74[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,29,POKEMON_MENKI),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,28,POKEMON_MASCHOCK)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x76[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,27,POKEMON_KADABRA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,26,POKEMON_SPOINK),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,27,POKEMON_BRONZEL)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x77[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,29,POKEMON_PANDIR)
};

trainer_pokemon_default_item_default_attacks trainer_party_x78[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,29,POKEMON_TENTACHA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,28,POKEMON_SEEMON)
};

trainer_pokemon_default_item_default_attacks trainer_party_x79[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0,0,0,false,false,32,POKEMON_KICKLEE)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x7c[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,29,POKEMON_MEDITIE),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,28,POKEMON_RIOLU)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x85[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,30,POKEMON_PUPPANCE),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_BRONZEL)
};

trainer_pokemon_default_item_default_attacks trainer_party_x86[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_HUNDUSTER),
...
trainer_pokemon_default_item_default_attacks trainer_party_x87[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_STARAPTOR),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,32,POKEMON_ELEVOLTEK),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,29,POKEMON_NOKTUSKA)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x88[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,30,POKEMON_SICHLOR)
};

trainer_pokemon_default_item_default_attacks trainer_party_x89[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_DODRI),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_KRAMURX)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x8b[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_NASGNET),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_SCHLUPPUCK)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x92[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_CAMAUB)
};

trainer_pokemon_default_item_default_attacks trainer_party_x93[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_SANDAMER),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,32,POKEMON_VULPIX),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_MAGBY)
};

trainer_pokemon_default_item_default_attacks trainer_party_x94[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_KIRLIA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_VULPIX)
};

trainer_pokemon_default_item_default_attacks trainer_party_x95[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,30,POKEMON_CAMAUB),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_SCHNECKMAG),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_MAGMAR),
...
trainer_pokemon_default_item_default_attacks trainer_party_x96[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,36,POKEMON_HUNDEMON)
};

trainer_pokemon_default_item_default_attacks trainer_party_x97[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_ORTHODOS),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_MAGNETON)
};

trainer_pokemon_default_item_default_attacks trainer_party_x98[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_ARKANI),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_GRANBULL),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,32,POKEMON_PANZAERON)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x99[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_FUKANO)
};

trainer_pokemon_default_item_default_attacks trainer_party_x9a[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,33,POKEMON_GEOROK),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,32,POKEMON_ONIX),
...
trainer_pokemon_default_item_default_attacks trainer_party_x9c[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,36,POKEMON_CAMERUPT),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,35,POKEMON_NIDOQUEEN),
...
trainer_pokemon_default_item_default_attacks trainer_party_x9d[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_FLOETTE)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x9e[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_SLEIMOK)
};

trainer_pokemon_default_item_default_attacks trainer_party_x9f[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,30,POKEMON_PARAGONI),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,31,POKEMON_NIDORANW),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,32,POKEMON_LEDYBA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,30,POKEMON_PANDIR),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,30,POKEMON_RIHORN),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,30,POKEMON_FLUNKIFER)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_xa1[] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,35,POKEMON_PUPPANCE)
};

trainer_pokemon_default_item_default_attacks trainer_party_xa2[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_SMOGON),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_ORTHODOS)
};

trainer_pokemon_default_item_default_attacks trainer_party_xa3[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_TRAUMATO),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,35,POKEMON_GOLBAT)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_xa6[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,36,POKEMON_NIDORINA)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_xa8[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,36,POKEMON_STOLLRAK)
};

trainer_pokemon_default_item_default_attacks trainer_party_xa9[] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,37,POKEMON_URSARING),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,36,POKEMON_XATU),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,35,POKEMON_SEESKULL)
};
...
trainer_pokemon_custom_item_custom_attacks trainer_party_xb7[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_SPECIAL_TANK, 0x0, false, false, 23, POKEMON_BISAKNOSP, ITEM_TSITRUBEERE, ATTACK_EGELSAMEN, ATTACK_GIGASAUGER, ATTACK_TOXIN, ATTACK_MATSCHBOMBE),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 24, POKEMON_KAPILZ, ITEM_NONE, ATTACK_TEMPOHIEB, ATTACK_PILZSPORE, ATTACK_KOPFNUSS, ATTACK_SAMENBOMBEN),
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_SPECIAL_TANK, 0x0, false, false, 25, POKEMON_KAPPALORES, ITEM_BLENDPUDER, ATTACK_DOPPELTEAM, ATTACK_EGELSAMEN, ATTACK_AQUAWELLE, ATTACK_GIGASAUGER)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xb8[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_SPEED_PREFERENCE, 0x0, false, false, 34, POKEMON_MEDITALIS, ITEM_NONE, ATTACK_ZEN_KOPFSTOSS, ATTACK_PROTZER, ATTACK_POWER_PUNCH, ATTACK_DURCHBRUCH),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_TANK, 0x0, false, false, 35, POKEMON_MACHOMEI, ITEM_SCHWARZGURT, ATTACK_WUCHTSCHLAG, ATTACK_STEINKANTE, ATTACK_ERDBEBEN, ATTACK_DONNERSCHLAG),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 35, POKEMON_SKARABORN, ITEM_PRUNUSBEERE, ATTACK_VIELENDER, ATTACK_NAHKAMPF, ATTACK_STEINKANTE, ATTACK_POWER_PUNCH),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 36, POKEMON_LUCARIO, ITEM_TSITRUBEERE, ATTACK_NAHKAMPF, ATTACK_EISENSCHWEIF, ATTACK_ERDBEBEN, ATTACK_PROTZER)
};
...
trainer_pokemon_custom_item_custom_attacks trainer_party_xb9[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 20, POKEMON_KAUMALAT, ITEM_NONE, ATTACK_DRACHENWUT, ATTACK_SCHAUFLER, ATTACK_KRATZER, ATTACK_BODYCHECK)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xba[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 20, POKEMON_KINDWURM, ITEM_NONE, ATTACK_GLUT, ATTACK_TACKLE, ATTACK_KOPFNUSS, ATTACK_DRACHENKLAUE)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xbb[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(11, TRAINER_BUILD_PHYSICAL_TANK, 0x0, false, false, 19, POKEMON_DRATINI, ITEM_NONE, ATTACK_DONNERWELLE, ATTACK_DRACHENWUT, ATTACK_WINDHOSE, ATTACK_SURFER)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xbc[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_TANK, 0x0, false, false, 36, POKEMON_BISAFLOR, ITEM_NONE, ATTACK_SCHLAFPUDER, ATTACK_EGELSAMEN, ATTACK_SYNTHESE, ATTACK_ENERGIEBALL),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 35, POKEMON_AZUMARILL, ITEM_NONE, ATTACK_KNUDDLER, ATTACK_NASSSCHWEIF, ATTACK_KRAFTKOLOSS, ATTACK_EISHIEB),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_SWEEPER_SPECIAL_ATTACK_PREFERENCE, 0x0, false, false, 38, POKEMON_ZERBERTRES, ITEM_TSITRUBEERE, ATTACK_ZORNFEUER, ATTACK_FINSTERAURA, ATTACK_SONDERSENSOR, ATTACK_RUCKZUCKHIEB),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 37, POKEMON_KNARKSEL, ITEM_NONE, ATTACK_TACKLE, ATTACK_DRACHENKLAUE, ATTACK_STEINHAGEL, ATTACK_SCHLITZER)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xbd[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_SWEEPER_SPEED_PREFERENCE, 0x1, false, false, 36, POKEMON_GLURAK, ITEM_NONE, ATTACK_FLAMMENWURF, ATTACK_FLIEGEN, ATTACK_STEINHAGEL, ATTACK_DUNKELKLAUE),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_TANK, 0x0, false, false, 35, POKEMON_KOKOWEI, ITEM_NONE, ATTACK_PSYCHOKINESE, ATTACK_REFLEKTOR, ATTACK_LICHTSCHILD, ATTACK_ENERGIEBALL),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_SWEEPER_SPECIAL_ATTACK_PREFERENCE, 0x0, false, false, 38, POKEMON_SKULLYDRA, ITEM_TSITRUBEERE, ATTACK_TSUNAMI, ATTACK_DRACHENPULS, ATTACK_FINSTERAURA, ATTACK_EISENSCHWEIF),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0x0, false, false, 37, POKEMON_DRASCHEL, ITEM_NONE, ATTACK_DRACHENKLAUE, ATTACK_SCHUTZSCHILD, ATTACK_BODYCHECK, ATTACK_GLUT)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xbe[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_TANK, 0x0, false, false, 36, POKEMON_TURTOK, ITEM_NONE, ATTACK_EISSTRAHL, ATTACK_SURFER, ATTACK_SCHAEDELWUMME, ATTACK_AURASPHAERE),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_PHYSICAL_TANK, 0x0, false, false, 38, POKEMON_STAHLSTICH, ITEM_TSITRUBEERE, ATTACK_SAMENBOMBEN, ATTACK_STAHLSTREICH, ATTACK_SCHLITZER, ATTACK_SCHWERTTANZ),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_SWEEPER_SPEED_PREFERENCE, 0x0, false, false, 35, POKEMON_MAGMAR, ITEM_NONE, ATTACK_FLAMMENWURF, ATTACK_KONFUSTRAHL, ATTACK_FOKUSSTOSS, ATTACK_NONE),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_PHYSICAL_TANK, 0x0, false, false, 37, POKEMON_DRAGONIR, ITEM_NONE, ATTACK_DONNERWELLE, ATTACK_DONNERBLITZ, ATTACK_DRACHENPULS, ATTACK_SURFER)
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x132_route_12_clouds_trainer_3[2] = {
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 37, POKEMON_VOLTENSO),
...
trainer_pokemon_default_item_default_attacks trainer_party_x13f_route_7_trainer_0[2] = {
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 33, POKEMON_GLUTEXO),
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 34, POKEMON_FUKANO),
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x141_route_7_trainer_2[2] = {
  ...
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 34, POKEMON_VOLTENSO),
};

trainer_pokemon_default_item_default_attacks trainer_party_x142_route_7_trainer_3[3] = {
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 33, POKEMON_KANIVANHA),
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 34, POKEMON_QUABBEL),
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 35, POKEMON_REMORAID),
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x14f_route_7_trainer_16[3] = {
  ...
  TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 38, POKEMON_PLUSLE),
};
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x169_kuestenberg_felix[3] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_PHYSICAL_SWEEPER_ATTACK_PREFERENCE, 0, 0, 0, 28, 
		POKEMON_MUNTIER, ITEM_SEIDENSCHAL, ATTACK_SCHLITZER, ATTACK_DUNKELKLAUE, ATTACK_AERO_ASS, ATTACK_NACHTHIEB),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_SPECIAL_TANK, 0, 0, 0, 30, 
		POKEMON_SCHLURP, ITEM_TSITRUBEERE, ATTACK_SLAM, ATTACK_SCHLECKER, ATTACK_DONNERBLITZ, ATTACK_FLAMMENWURF),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(17, TRAINER_BUILD_PHYSICAL_TANK, 0, 0, 0, 29, 
...
trainer_pokemon_default_item_default_attacks trainer_party_x16a_kuestenberg_revolutionaer[2] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 26, POKEMON_PHANPY),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 27, POKEMON_WAILMER),
};

trainer_pokemon_default_item_default_attacks trainer_party_x16b_route_4_trainer_couple[4] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 28, POKEMON_SNUBBULL),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 29, POKEMON_KNUDDELUFF),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 27, POKEMON_MINUN),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 28, POKEMON_PLUSLE),
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x16d_route_5_twins[4] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 30, POKEMON_LEDYBA),
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 31, POKEMON_FLOETTE),
};

trainer_pokemon_default_item_default_attacks trainer_party_x16e_route_6_trainer_0[2] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 33, POKEMON_KAPOERA),
...
trainer_pokemon_default_item_default_attacks trainer_party_x16f_route_6_couple[4] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 33, POKEMON_SANDAMER),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 32, POKEMON_KADABRA),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0, 0x0, false, false, 33, POKEMON_SNUBBULL),
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x171_volcano_grunt_0[2] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,34,POKEMON_SCHLUPPUCK),
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x173_volcano_grunt_2[3] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,36,POKEMON_SCHLUKWECH),
...
trainer_pokemon_default_item_default_attacks trainer_party_x176_route_8_psycho_0[1] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,39,POKEMON_PSIANA),
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x177_route_8_couple[2] = {
	...
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,37,POKEMON_PUDOX),
};
...
trainer_pokemon_default_item_default_attacks trainer_party_x179_route_7_twins[2] = {
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,35,POKEMON_MINUN),
	TRAINER_PARTY_DEFAULT_ITEM_DEFAULT_MOVES(0x0, 0x0,0x0,false,false,37,POKEMON_PLUSLE),
};
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x199_bbship_blackbeard[5] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_xb6[] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1a1_lester_difficulty_normal[4] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1a2_lester_difficulty_hard[6] = {
