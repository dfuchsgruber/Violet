...
trainer_pokemon_default_item_default_attacks trainer_party_x1de_route_7_north_couple[2] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1df_route_7_north_cook[4] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1e4_dungeon_forest_veteran[5] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, 0x0, 0x0, false, false, TRAINER_POKEMON_LEVEL_STORY_BASED_PLUS_ONE_STD, POKEMON_MAMUTEL, ITEM_UEBERRESTE, ATTACK_STEINKANTE, ATTACK_ERDBEBEN, ATTACK_EISSPLITTER, ATTACK_BRUELLER)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_x1e5_dungeon_forest_veteran[5] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1e6_dungeon_forest_veteran[5] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1e7_dungeon_forest_veteran[5] = {
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1e8_dungeon_forest_veteran[6] = {
