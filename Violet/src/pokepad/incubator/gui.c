...
sprite oam_sprite_incubator_egg = {.attr0 = ATTR0_SHAPE_SQUARE, .attr1 = ATTR1_SIZE_64_64, .attr2 = ATTR2_PRIO(2)};

sprite oam_sprite_incubator_progress_bar = {.attr0 = ATTR0_SHAPE_HORIZONTAL,
                                            .attr1 = ATTR1_SIZE_32_8,
                                            .attr2 = ATTR2_PRIO(2)};
...
graphic graphic_incubator_progress_bar = {.size = (32 * 8 / 2),
                                          .tag = INCUBATOR_EGG_PROGRESS_TAG,
                                          .sprite = gfx_incubator_progress_barTiles};

graphic graphic_incubator_selection = {.size = (64 * 64 / 2),
                                       .tag = INCUBATOR_SELECTION_TAG_LEFT,
                                       .sprite = gfx_incubator_selectionTiles};

gfx_frame gfx_animation_incubator_egg_icon[] = {
    {.data = 0, .duration = 16}, {.data = 16, .duration = 16}, {.data = GFX_ANIM_JUMP, .duration = 0}};
...
oam_template oam_template_incubator_egg = {
    .oam = &oam_sprite_incubator_egg, .tiles_tag = INCUBATOR_EGG_TAG, .pal_tag = INCUBATOR_EGG_TAG, .callback = incubator_oam_egg_callback, .graphics = NULL, .animation = oam_gfx_anim_table_null, .rotscale = oam_rotscale_anim_table_null};

oam_template oam_template_incubator_progress_bar = {
    .oam = &oam_sprite_incubator_progress_bar, .tiles_tag = INCUBATOR_EGG_PROGRESS_TAG, .pal_tag = INCUBATOR_EGG_PROGRESS_TAG, .callback = oam_null_callback, .graphics = NULL, .animation = oam_gfx_anim_table_null, .rotscale = oam_rotscale_anim_table_null};

oam_template oam_template_incubator_egg_icon = {
    .oam = &oam_sprite_incubator_egg_icon, .tiles_tag = INCUBATOR_EGG_ICON_TAG, .pal_tag = INCUBATOR_EGG_ICON_TAG, .callback = oam_null_callback, .graphics = NULL, .animation = gfx_animation_table_incubator_egg_icon, .rotscale = rotscale_animation_table_incubator_egg_icon};

oam_template oam_template_incubator_selection_left = {
    .oam = &oam_sprite_incubator_selection, .tiles_tag = INCUBATOR_SELECTION_TAG_LEFT, .pal_tag = INCUBATOR_SELECTION_TAG_LEFT, .callback = oam_null_callback, .graphics = NULL, .animation = oam_gfx_anim_table_null, .rotscale = oam_rotscale_anim_table_null};

oam_template oam_template_incubator_selection_right = {
    .oam = &oam_sprite_incubator_selection, .tiles_tag = INCUBATOR_SELECTION_TAG_LEFT, .pal_tag = INCUBATOR_SELECTION_TAG_LEFT, .callback = oam_null_callback, .graphics = NULL, .animation = gfx_animation_table_incubator_selection_right, .rotscale = oam_rotscale_anim_table_null};
...
void incubator_load_temperature() {
    u16 pixels = (u16)(((1000 - *var_access(HATCHING_BOOST_STEPS)) * INCUBATOR_TEMPERATURE_PIXELS) / 1000);
...
void incubator_load_selection() {
    for (int i = 0; i < 2; i++) {
        oams[fmem.incubator_state->oam_selection[i]].y = (s16)(8 *
                                                                   (6 + 4 * fmem.incubator_state->cursor_idx) +
                                                               12);
    }
}
...
static void incubator_callback_initialize_pc_selection() {
    generic_callback1();
    if (!fading_is_active()) {
...
static bool incubator_pokemon_can_be_imported(box_pokemon *p) {
    return box_pokemon_get_attribute(p, ATTRIBUTE_SANITY_HAS_SPECIES, 0) &&
           !box_pokemon_get_attribute(p, ATTRIBUTE_SANITY_IS_BAD_EGG, 0) &&
           box_pokemon_get_attribute(p, ATTRIBUTE_SANITY_IS_EGG, 0);
}
...
tboxdata incubator_tboxes[INCUBATOR_TBOX_CNT + 1] = {
    [INCUBATOR_TBOX_TITLE] = {.bg_id = 0, .x = 11, .y = 0, .w = 8, .h = 2, .pal = 14, .start_tile = INCUBATOR_TBOX_START_TILE},
    [INCUBATOR_TBOX_EGG] = {.bg_id = 0, .x = 3, .y = 3, .w = 4, .h = 2, .pal = 14, .start_tile = INCUBATOR_TBOX_START_TILE + 16},
    [INCUBATOR_TBOX_TYPES] = {.bg_id = 0, .x = 12, .y = 3, .w = 8, .h = 2, .pal = 12, .start_tile = INCUBATOR_TBOX_START_TILE + 24},
    [INCUBATOR_TBOX_CONTEXT_MENU_EGG] = {.bg_id = 0, .x = 20, .y = 13, .w = 9, .h = 6, .pal = 14, .start_tile = INCUBATOR_TBOX_START_TILE + 40},
    [INCUBATOR_TBOX_CONTEXT_MENU_EMPTY] = {.bg_id = 0, .x = 20, .y = 13, .w = 9, .h = 6, .pal = 14, .start_tile = INCUBATOR_TBOX_START_TILE + 40},
    [INCUBATOR_TBOX_MESSAGE] = {.bg_id = 0, .x = 2, .y = 15, .w = 26, .h = 4, .pal = 14, .start_tile = INCUBATOR_TBOX_START_TILE + 94},
