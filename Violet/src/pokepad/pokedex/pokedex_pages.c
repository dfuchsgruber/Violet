...
const u16 pokedex_habitat_selten_page_0[1] = {
    POKEMON_ICOGNITO
};
// Habitat selten, page 1
const u16 pokedex_habitat_selten_page_1[3] = {
    POKEMON_ARKTOS, POKEMON_ZAPDOS, POKEMON_LAVADOS
};
// Habitat selten, page 2
const u16 pokedex_habitat_selten_page_2[1] = {
    POKEMON_LUGIA
};
// Habitat selten, page 3
const u16 pokedex_habitat_selten_page_3[1] = {
    POKEMON_HO_OH
};
// Habitat selten, page 4
const u16 pokedex_habitat_selten_page_4[1] = {
    POKEMON_RAYQUAZA
};
// Habitat selten, page 5
const u16 pokedex_habitat_selten_page_5[1] = {
    POKEMON_DEOXYS
};
// Habitat selten, page 6
const u16 pokedex_habitat_selten_page_6[1] = {
    POKEMON_MEWTU
};
// Habitat selten, page 7
const u16 pokedex_habitat_selten_page_7[1] = {
    POKEMON_MEW
};

const pokedex_page pokedex_habitat_selten_pages [9] = {
...
const pokedex_habitat pokedex_habitats [9] = {
