...
void pokedex_entry_load_strings() {
    ...
    *buf = 0xFF;
    ...
    tbox_print_string(1, 2, 8, 0, 0, 0, &pokedex_fontcolmap, 0, is_caught ? pokedex_get_data(dex_id)->category : str_qmark);
    ...
    tbox_print_string(2, 2, 0, 0, 0, 1, &pokedex_fontcolmap, 0, is_caught ? pokedex_get_data(dex_id)->page0 : str_qmark);
    if (is_caught) {
