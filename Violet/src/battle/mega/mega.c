...
static const mega_evolution_t mega_evolutions[] = {
    ...
    {POKEMON_FIRNONTOR, ITEM_FIRNONTORNIT, POKEMON_MEGA_FIRNONTOR, MEGA_EVOLUTION},
    {POKEMON_BIBOR, ITEM_BIBORNIT, POKEMON_MEGA_BIBOR, MEGA_EVOLUTION},
    {POKEMON_JUGONG, ITEM_JUGONGNIT, POKEMON_MEGA_JUGONG, MEGA_EVOLUTION},
    {POKEMON_AMPHAROS, ITEM_AMPHAROSNIT, POKEMON_MEGA_AMPHAROS, MEGA_EVOLUTION},
    {POKEMON_ZOBIRIS, ITEM_ZOBIRISNIT, POKEMON_MEGA_ZOBIRIS, MEGA_EVOLUTION},
    {POKEMON_FLUNKIFER, ITEM_FLUNKIFERNIT, POKEMON_MEGA_FLUNKIFER, MEGA_EVOLUTION},
    {POKEMON_SENGO, ITEM_SENGONIT, POKEMON_MEGA_SENGO, MEGA_EVOLUTION},
    {POKEMON_VIPITIS, ITEM_VIPITISNIT, POKEMON_MEGA_VIPITIS, MEGA_EVOLUTION},
    {POKEMON_PALIMPALIM, ITEM_PALIMPALIMNIT, POKEMON_MEGA_PALIMPALIM, MEGA_EVOLUTION},
