...
bool battle_abilities_attack_done_attacker_new() {
    ...
    if (attacker->ability == LERNFAEHIG && attacker->current_hp &&
        ...
        return true;
               ...
               !battler_statuses[attacking_battler].hurt_in_confusion && DAMAGE_CAUSED && !defender->current_hp && attacker->stat_changes[1] < 12) {
        ...
        return true;
               ...
               attacks[active_attack].base_power && attacker->current_hp < attacker->max_hp &&
