...
/* 
.global battle_ai_scripts

.align 2
battle_ai_scripts: @ 81D9BF4
	.word AI_CheckBadMove
	.word AI_CheckViability
	.word AI_TryToFaint
	.word AI_SetupFirstTurn
	.word AI_Risky
	.word AI_PreferStrongestMove
	.word AI_PreferBatonPass
	.word AI_DoubleBattle
	.word AI_HPAware
	.word AI_Unknown
	.word AI_Ret
	.word AI_Ret
...
AI_CheckBadMove_CheckEffect: @ 81D9D27
	if_effect ATTACK_EFFECT_SLEEP, AI_CBM_Sleep
	if_effect ATTACK_EFFECT_EXPLOSION, AI_CBM_Explosion
	if_effect ATTACK_EFFECT_DREAM_EATER, AI_CBM_DreamEater
	if_effect ATTACK_EFFECT_ATTACK_UP, AI_CBM_AttackUp
	if_effect ATTACK_EFFECT_DEFENSE_UP, AI_CBM_DefenseUp
	if_effect ATTACK_EFFECT_SPEED_UP, AI_CBM_SpeedUp
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_UP, AI_CBM_SpAtkUp
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_UP, AI_CBM_SpDefUp
	if_effect ATTACK_EFFECT_ACCURACY_UP, AI_CBM_AccUp
	if_effect ATTACK_EFFECT_EVASION_UP, AI_CBM_EvasionUp
	if_effect ATTACK_EFFECT_ATTACK_DOWN, AI_CBM_AttackDown
	if_effect ATTACK_EFFECT_DEFENSE_DOWN, AI_CBM_DefenseDown
	if_effect ATTACK_EFFECT_SPEED_DOWN, AI_CBM_SpeedDown
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_DOWN, AI_CBM_SpAtkDown
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_DOWN, AI_CBM_SpDefDown
	if_effect ATTACK_EFFECT_ACCURACY_DOWN, AI_CBM_AccDown
	if_effect ATTACK_EFFECT_EVASION_DOWN, AI_CBM_EvasionDown
	if_effect ATTACK_EFFECT_HAZE, AI_CBM_Haze
	if_effect ATTACK_EFFECT_BIDE, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_ROAR, AI_CBM_Roar
	if_effect ATTACK_EFFECT_TOXIC, AI_CBM_Poison
	if_effect ATTACK_EFFECT_LIGHT_SCREEN, AI_CBM_LightScreen
	if_effect ATTACK_EFFECT_OHKO, AI_CBM_OneHitKO
	if_effect ATTACK_EFFECT_RAZOR_WIND, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_SUPER_FANG, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_MIST, AI_CBM_Mist
	if_effect ATTACK_EFFECT_FOCUS_ENERGY, AI_CBM_FocusEnergy
	if_effect ATTACK_EFFECT_CONFUSE, AI_CBM_Confuse
	if_effect ATTACK_EFFECT_ATTACK_UP_2, AI_CBM_AttackUp
	if_effect ATTACK_EFFECT_DEFENSE_UP_2, AI_CBM_DefenseUp
	if_effect ATTACK_EFFECT_SPEED_UP_2, AI_CBM_SpeedUp
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_UP_2, AI_CBM_SpAtkUp
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_UP_2, AI_CBM_SpDefUp
	if_effect ATTACK_EFFECT_ACCURACY_UP_2, AI_CBM_AccUp
	if_effect ATTACK_EFFECT_EVASION_UP_2, AI_CBM_EvasionUp
	if_effect ATTACK_EFFECT_ATTACK_DOWN_2, AI_CBM_AttackDown
	if_effect ATTACK_EFFECT_DEFENSE_DOWN_2, AI_CBM_DefenseDown
	if_effect ATTACK_EFFECT_SPEED_DOWN_2, AI_CBM_SpeedDown
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_DOWN_2, AI_CBM_SpAtkDown
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_DOWN_2, AI_CBM_SpDefDown
	if_effect ATTACK_EFFECT_ACCURACY_DOWN_2, AI_CBM_AccDown
	if_effect ATTACK_EFFECT_EVASION_DOWN_2, AI_CBM_EvasionDown
	if_effect ATTACK_EFFECT_REFLECT, AI_CBM_Reflect
	if_effect ATTACK_EFFECT_POISON, AI_CBM_Poison
	if_effect ATTACK_EFFECT_PARALYZE, AI_CBM_Paralyze
	if_effect ATTACK_EFFECT_SUBSTITUTE, AI_CBM_Substitute
	if_effect ATTACK_EFFECT_RECHARGE, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_LEECH_SEED, AI_CBM_LeechSeed
	if_effect ATTACK_EFFECT_DISABLE, AI_CBM_Disable
	if_effect ATTACK_EFFECT_LEVEL_DAMAGE, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_PSYWAVE, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_COUNTER, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_ENCORE, AI_CBM_Encore
	if_effect ATTACK_EFFECT_SNORE, AI_CBM_DamageDuringSleep
	if_effect ATTACK_EFFECT_SLEEP_TALK, AI_CBM_DamageDuringSleep
	if_effect ATTACK_EFFECT_FLAIL, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_MEAN_LOOK, AI_CBM_CantEscape
	if_effect ATTACK_EFFECT_NIGHTMARE, AI_CBM_Nightmare
	if_effect ATTACK_EFFECT_MINIMIZE, AI_CBM_EvasionUp
	if_effect ATTACK_EFFECT_CURSE, AI_CBM_Curse
	if_effect ATTACK_EFFECT_SPIKES, AI_CBM_Spikes
	if_effect ATTACK_EFFECT_FORESIGHT, AI_CBM_Foresight
	if_effect ATTACK_EFFECT_PERISH_SONG, AI_CBM_PerishSong
	if_effect ATTACK_EFFECT_SANDSTORM, AI_CBM_Sandstorm
	if_effect ATTACK_EFFECT_SWAGGER, AI_CBM_Confuse
	if_effect ATTACK_EFFECT_ATTRACT, AI_CBM_Attract
	if_effect ATTACK_EFFECT_RETURN, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_PRESENT, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_FRUSTRATION, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_SAFEGUARD, AI_CBM_Safeguard
	if_effect ATTACK_EFFECT_MAGNITUDE, AI_CBM_Magnitude
	if_effect ATTACK_EFFECT_BATON_PASS, AI_CBM_BatonPass
	if_effect ATTACK_EFFECT_SONICBOOM, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_RAIN_DANCE, AI_CBM_RainDance
	if_effect ATTACK_EFFECT_SUNNY_DAY, AI_CBM_SunnyDay
	if_effect ATTACK_EFFECT_BELLY_DRUM, AI_CBM_BellyDrum
	if_effect ATTACK_EFFECT_PSYCH_UP, AI_CBM_Haze
	if_effect ATTACK_EFFECT_MIRROR_COAT, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_SKULL_BASH, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_FUTURE_SIGHT, AI_CBM_FutureSight
	if_effect ATTACK_EFFECT_TELEPORT, Score_Minus10
	if_effect ATTACK_EFFECT_DEFENSE_CURL, AI_CBM_DefenseUp
	if_effect ATTACK_EFFECT_FAKE_OUT, AI_CBM_FakeOut
	if_effect ATTACK_EFFECT_STOCKPILE, AI_CBM_Stockpile
	if_effect ATTACK_EFFECT_SPIT_UP, AI_CBM_SpitUpAndSwallow
	if_effect ATTACK_EFFECT_SWALLOW, AI_CBM_SpitUpAndSwallow
	if_effect ATTACK_EFFECT_HAIL, AI_CBM_Hail
	if_effect ATTACK_EFFECT_TORMENT, AI_CBM_Torment
	if_effect ATTACK_EFFECT_FLATTER, AI_CBM_Confuse
	if_effect ATTACK_EFFECT_WILL_O_WISP, AI_CBM_WillOWisp
	if_effect ATTACK_EFFECT_MEMENTO, AI_CBM_Memento
	if_effect ATTACK_EFFECT_FOCUS_PUNCH, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_HELPING_HAND, AI_CBM_HelpingHand
	if_effect ATTACK_EFFECT_TRICK, AI_CBM_TrickAndKnockOff
	if_effect ATTACK_EFFECT_INGRAIN, AI_CBM_Ingrain
	if_effect ATTACK_EFFECT_SUPERPOWER, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_RECYCLE, AI_CBM_Recycle
	if_effect ATTACK_EFFECT_KNOCK_OFF, AI_CBM_TrickAndKnockOff
	if_effect ATTACK_EFFECT_ENDEAVOR, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_IMPRISON, AI_CBM_Imprison
	if_effect ATTACK_EFFECT_REFRESH, AI_CBM_Refresh
	if_effect ATTACK_EFFECT_LOW_KICK, AI_CBM_HighRiskForDamage
	if_effect ATTACK_EFFECT_MUD_SPORT, AI_CBM_MudSport
	if_effect ATTACK_EFFECT_TICKLE, AI_CBM_Tickle
	if_effect ATTACK_EFFECT_COSMIC_POWER, AI_CBM_CosmicPower
	if_effect ATTACK_EFFECT_BULK_UP, AI_CBM_BulkUp
	if_effect ATTACK_EFFECT_WATER_SPORT, AI_CBM_WaterSport
	if_effect ATTACK_EFFECT_CALM_MIND, AI_CBM_CalmMind
	if_effect ATTACK_EFFECT_DRAGON_DANCE, AI_CBM_DragonDance
	end
...
AI_CBM_Refresh: @ 81DA3AE
	if_not_status AI_USER, STATUS1_POISONED | STATUS1_BURNED | STATUS1_PARALYZED | STATUS1_BADLY_POISONED, Score_Minus10
	end
...
AI_CheckViability: @ 81DA445
	if_effect ATTACK_EFFECT_SLEEP, AI_CV_Sleep
	if_effect ATTACK_EFFECT_ABSORB, AI_CV_Absorb
	if_effect ATTACK_EFFECT_EXPLOSION, AI_CV_SelfKO
	if_effect ATTACK_EFFECT_DREAM_EATER, AI_CV_DreamEater
	if_effect ATTACK_EFFECT_MIRROR_MOVE, AI_CV_MirrorMove
	if_effect ATTACK_EFFECT_ATTACK_UP, AI_CV_AttackUp
	if_effect ATTACK_EFFECT_DEFENSE_UP, AI_CV_DefenseUp
	if_effect ATTACK_EFFECT_SPEED_UP, AI_CV_SpeedUp
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_UP, AI_CV_SpAtkUp
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_UP, AI_CV_SpDefUp
	if_effect ATTACK_EFFECT_ACCURACY_UP, AI_CV_AccuracyUp
	if_effect ATTACK_EFFECT_EVASION_UP, AI_CV_EvasionUp
	if_effect ATTACK_EFFECT_ALWAYS_HIT, AI_CV_AlwaysHit
	if_effect ATTACK_EFFECT_ATTACK_DOWN, AI_CV_AttackDown
	if_effect ATTACK_EFFECT_DEFENSE_DOWN, AI_CV_DefenseDown
	if_effect ATTACK_EFFECT_SPEED_DOWN, AI_CV_SpeedDown
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_DOWN, AI_CV_SpAtkDown
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_DOWN, AI_CV_SpDefDown
	if_effect ATTACK_EFFECT_ACCURACY_DOWN, AI_CV_AccuracyDown
	if_effect ATTACK_EFFECT_EVASION_DOWN, AI_CV_EvasionDown
	if_effect ATTACK_EFFECT_HAZE, AI_CV_Haze
	if_effect ATTACK_EFFECT_BIDE, AI_CV_Bide
	if_effect ATTACK_EFFECT_ROAR, AI_CV_Roar
	if_effect ATTACK_EFFECT_CONVERSION, AI_CV_Conversion
	if_effect ATTACK_EFFECT_RESTORE_HP, AI_CV_Heal
	if_effect ATTACK_EFFECT_TOXIC, AI_CV_Toxic
	if_effect ATTACK_EFFECT_LIGHT_SCREEN, AI_CV_LightScreen
	if_effect ATTACK_EFFECT_REST, AI_CV_Rest
	if_effect ATTACK_EFFECT_OHKO, AI_CV_OneHitKO
	if_effect ATTACK_EFFECT_RAZOR_WIND, AI_CV_ChargeUpMove
	if_effect ATTACK_EFFECT_SUPER_FANG, AI_CV_SuperFang
	if_effect ATTACK_EFFECT_TRAP, AI_CV_Trap
	if_effect ATTACK_EFFECT_HIGH_CRITICAL, AI_CV_HighCrit
	if_effect ATTACK_EFFECT_CONFUSE, AI_CV_Confuse
	if_effect ATTACK_EFFECT_ATTACK_UP_2, AI_CV_AttackUp
	if_effect ATTACK_EFFECT_DEFENSE_UP_2, AI_CV_DefenseUp
	if_effect ATTACK_EFFECT_SPEED_UP_2, AI_CV_SpeedUp
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_UP_2, AI_CV_SpAtkUp
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_UP_2, AI_CV_SpDefUp
	if_effect ATTACK_EFFECT_ACCURACY_UP_2, AI_CV_AccuracyUp
	if_effect ATTACK_EFFECT_EVASION_UP_2, AI_CV_EvasionUp
	if_effect ATTACK_EFFECT_ATTACK_DOWN_2, AI_CV_AttackDown
	if_effect ATTACK_EFFECT_DEFENSE_DOWN_2, AI_CV_DefenseDown
	if_effect ATTACK_EFFECT_SPEED_DOWN_2, AI_CV_SpeedDown
	if_effect ATTACK_EFFECT_SPECIAL_ATTACK_DOWN_2, AI_CV_SpAtkDown
	if_effect ATTACK_EFFECT_SPECIAL_DEFENSE_DOWN_2, AI_CV_SpDefDown
	if_effect ATTACK_EFFECT_ACCURACY_DOWN_2, AI_CV_AccuracyDown
	if_effect ATTACK_EFFECT_EVASION_DOWN_2, AI_CV_EvasionDown
	if_effect ATTACK_EFFECT_REFLECT, AI_CV_Reflect
	if_effect ATTACK_EFFECT_POISON, AI_CV_Poison
	if_effect ATTACK_EFFECT_PARALYZE, AI_CV_Paralyze
	if_effect ATTACK_EFFECT_SWAGGER, AI_CV_Swagger  @ Improvement in Emerald
	if_effect ATTACK_EFFECT_SPEED_DOWN_HIT, AI_CV_SpeedDownFromChance
	if_effect ATTACK_EFFECT_SKY_ATTACK, AI_CV_ChargeUpMove
	if_effect ATTACK_EFFECT_VITAL_THROW, AI_CV_VitalThrow
	if_effect ATTACK_EFFECT_SUBSTITUTE, AI_CV_Substitute
	if_effect ATTACK_EFFECT_RECHARGE, AI_CV_Recharge
	if_effect ATTACK_EFFECT_LEECH_SEED, AI_CV_Toxic
	if_effect ATTACK_EFFECT_DISABLE, AI_CV_Disable
	if_effect ATTACK_EFFECT_COUNTER, AI_CV_Counter
	if_effect ATTACK_EFFECT_ENCORE, AI_CV_Encore
	if_effect ATTACK_EFFECT_PAIN_SPLIT, AI_CV_PainSplit
	if_effect ATTACK_EFFECT_SNORE, AI_CV_Snore
	if_effect ATTACK_EFFECT_LOCK_ON, AI_CV_LockOn
	if_effect ATTACK_EFFECT_SLEEP_TALK, AI_CV_SleepTalk
	if_effect ATTACK_EFFECT_DESTINY_BOND, AI_CV_DestinyBond
	if_effect ATTACK_EFFECT_FLAIL, AI_CV_Flail
	if_effect ATTACK_EFFECT_HEAL_BELL, AI_CV_HealBell
	if_effect ATTACK_EFFECT_THIEF, AI_CV_Thief
	if_effect ATTACK_EFFECT_MEAN_LOOK, AI_CV_Trap
	if_effect ATTACK_EFFECT_MINIMIZE, AI_CV_EvasionUp
	if_effect ATTACK_EFFECT_CURSE, AI_CV_Curse
	if_effect ATTACK_EFFECT_PROTECT, AI_CV_Protect
	if_effect ATTACK_EFFECT_FORESIGHT, AI_CV_Foresight
	if_effect ATTACK_EFFECT_ENDURE, AI_CV_Endure
	if_effect ATTACK_EFFECT_BATON_PASS, AI_CV_BatonPass
	if_effect ATTACK_EFFECT_PURSUIT, AI_CV_Pursuit
	if_effect ATTACK_EFFECT_MORNING_SUN, AI_CV_HealWeather
	if_effect ATTACK_EFFECT_SYNTHESIS, AI_CV_HealWeather
	if_effect ATTACK_EFFECT_MOONLIGHT, AI_CV_HealWeather
	if_effect ATTACK_EFFECT_RAIN_DANCE, AI_CV_RainDance
	if_effect ATTACK_EFFECT_SUNNY_DAY, AI_CV_SunnyDay
	if_effect ATTACK_EFFECT_BELLY_DRUM, AI_CV_BellyDrum
	if_effect ATTACK_EFFECT_PSYCH_UP, AI_CV_PsychUp
	if_effect ATTACK_EFFECT_MIRROR_COAT, AI_CV_MirrorCoat
	if_effect ATTACK_EFFECT_SKULL_BASH, AI_CV_ChargeUpMove
	if_effect ATTACK_EFFECT_SOLARBEAM, AI_CV_ChargeUpMove
	if_effect ATTACK_EFFECT_SEMI_INVULNERABLE, AI_CV_SemiInvulnerable
	if_effect ATTACK_EFFECT_SOFTBOILED, AI_CV_Heal
	if_effect ATTACK_EFFECT_FAKE_OUT, AI_CV_FakeOut
	if_effect ATTACK_EFFECT_SPIT_UP, AI_CV_SpitUp
	if_effect ATTACK_EFFECT_SWALLOW, AI_CV_Heal
	if_effect ATTACK_EFFECT_HAIL, AI_CV_Hail
	if_effect ATTACK_EFFECT_FLATTER, AI_CV_Flatter
	if_effect ATTACK_EFFECT_MEMENTO, AI_CV_SelfKO
	if_effect ATTACK_EFFECT_FACADE, AI_CV_Facade
	if_effect ATTACK_EFFECT_FOCUS_PUNCH, AI_CV_FocusPunch
	if_effect ATTACK_EFFECT_SMELLINGSALT, AI_CV_SmellingSalt
	if_effect ATTACK_EFFECT_TRICK, AI_CV_Trick
	if_effect ATTACK_EFFECT_ROLE_PLAY, AI_CV_ChangeSelfAbility
	if_effect ATTACK_EFFECT_SUPERPOWER, AI_CV_Superpower
	if_effect ATTACK_EFFECT_MAGIC_COAT, AI_CV_MagicCoat
	if_effect ATTACK_EFFECT_RECYCLE, AI_CV_Recycle
	if_effect ATTACK_EFFECT_REVENGE, AI_CV_Revenge
	if_effect ATTACK_EFFECT_BRICK_BREAK, AI_CV_BrickBreak
	if_effect ATTACK_EFFECT_KNOCK_OFF, AI_CV_KnockOff
	if_effect ATTACK_EFFECT_ENDEAVOR, AI_CV_Endeavor
	if_effect ATTACK_EFFECT_ERUPTION, AI_CV_Eruption
	if_effect ATTACK_EFFECT_SKILL_SWAP, AI_CV_ChangeSelfAbility
	if_effect ATTACK_EFFECT_IMPRISON, AI_CV_Imprison
	if_effect ATTACK_EFFECT_REFRESH, AI_CV_Refresh
	if_effect ATTACK_EFFECT_SNATCH, AI_CV_Snatch
	if_effect ATTACK_EFFECT_BLAZE_KICK, AI_CV_HighCrit
	if_effect ATTACK_EFFECT_MUD_SPORT, AI_CV_MudSport
	if_effect ATTACK_EFFECT_OVERHEAT, AI_CV_Overheat
	if_effect ATTACK_EFFECT_TICKLE, AI_CV_DefenseDown
	if_effect ATTACK_EFFECT_COSMIC_POWER, AI_CV_SpDefUp
	if_effect ATTACK_EFFECT_BULK_UP, AI_CV_DefenseUp
	if_effect ATTACK_EFFECT_POISON_TAIL, AI_CV_HighCrit
	if_effect ATTACK_EFFECT_WATER_SPORT, AI_CV_WaterSport
	if_effect ATTACK_EFFECT_CALM_MIND, AI_CV_SpDefUp
	if_effect ATTACK_EFFECT_DRAGON_DANCE, AI_CV_DragonDance
	end

AI_CV_Sleep: @ 81DA71C
	if_has_move_with_effect AI_TARGET, ATTACK_EFFECT_DREAM_EATER, AI_CV_SleepEncourageSlpDamage
	if_has_move_with_effect AI_TARGET, ATTACK_EFFECT_NIGHTMARE, AI_CV_SleepEncourageSlpDamage
...
AI_CV_MirrorMove_EncouragedMovesToMirror: @ 81DA7F8
	.align 1
	.hword MOVE_SLEEP_POWDER
	.hword MOVE_LOVELY_KISS
	.hword MOVE_SPORE
	.hword MOVE_HYPNOSIS
	.hword MOVE_SING
	.hword MOVE_GRASS_WHISTLE
	.hword MOVE_SHADOW_PUNCH
	.hword MOVE_SAND_ATTACK
	.hword MOVE_SMOKESCREEN
	.hword MOVE_TOXIC
	.hword MOVE_GUILLOTINE
	.hword MOVE_HORN_DRILL
	.hword MOVE_FISSURE
	.hword MOVE_SHEER_COLD
	.hword MOVE_CROSS_CHOP
	.hword MOVE_AEROBLAST
	.hword MOVE_CONFUSE_RAY
	.hword MOVE_SWEET_KISS
	.hword MOVE_SCREECH
	.hword MOVE_COTTON_SPORE
	.hword MOVE_SCARY_FACE
	.hword MOVE_FAKE_TEARS
	.hword MOVE_METAL_SOUND
	.hword MOVE_THUNDER_WAVE
	.hword MOVE_GLARE
	.hword MOVE_POISON_POWDER
	.hword MOVE_SHADOW_BALL
	.hword MOVE_DYNAMIC_PUNCH
	.hword MOVE_HYPER_BEAM
...
AI_CV_EvasionUp3: @ 81DA9D9
	if_not_status AI_TARGET, STATUS1_BADLY_POISONED, AI_CV_EvasionUp5
...
AI_CV_AccuracyDown4: @ 81DABBE
	if_not_status AI_TARGET, STATUS1_BADLY_POISONED, AI_CV_AccuracyDown5
...
AI_CV_Heal5: @ 81DADC6
	if_doesnt_have_move_with_effect AI_TARGET, ATTACK_EFFECT_SNATCH, AI_CV_Heal6
...
AI_CV_Toxic3: @ 81DADFF
	if_has_move_with_effect AI_USER, ATTACK_EFFECT_SPECIAL_DEFENSE_UP, AI_CV_Toxic4
	if_has_move_with_effect AI_USER, ATTACK_EFFECT_PROTECT, AI_CV_Toxic4
...
AI_CV_Rest6: @ 81DAE94
	if_doesnt_have_move_with_effect AI_TARGET, ATTACK_EFFECT_SNATCH, AI_CV_Rest7
...
AI_CV_Trap: @ 81DAEB5
	if_status AI_TARGET, STATUS1_BADLY_POISONED, AI_CV_Trap2
...
AI_CV_Substitute4: @ 81DAFEA
	...
	if_equal ATTACK_EFFECT_SLEEP, AI_CV_Substitute5
	if_equal ATTACK_EFFECT_TOXIC, AI_CV_Substitute5
	if_equal ATTACK_EFFECT_POISON, AI_CV_Substitute5
	if_equal ATTACK_EFFECT_PARALYZE, AI_CV_Substitute5
	if_equal ATTACK_EFFECT_WILL_O_WISP, AI_CV_Substitute5
	if_equal ATTACK_EFFECT_CONFUSE, AI_CV_Substitute6
	if_equal ATTACK_EFFECT_LEECH_SEED, AI_CV_Substitute7
...
AI_CV_Encore_EncouragedMovesToEncore: @ 81DB164
	.byte ATTACK_EFFECT_DREAM_EATER
	.byte ATTACK_EFFECT_ATTACK_UP
	.byte ATTACK_EFFECT_DEFENSE_UP
	.byte ATTACK_EFFECT_SPEED_UP
	.byte ATTACK_EFFECT_SPECIAL_ATTACK_UP
	.byte ATTACK_EFFECT_HAZE
	.byte ATTACK_EFFECT_ROAR
	.byte ATTACK_EFFECT_CONVERSION
	.byte ATTACK_EFFECT_TOXIC
	.byte ATTACK_EFFECT_LIGHT_SCREEN
	.byte ATTACK_EFFECT_REST
	.byte ATTACK_EFFECT_SUPER_FANG
	.byte ATTACK_EFFECT_SPECIAL_DEFENSE_UP_2
	.byte ATTACK_EFFECT_CONFUSE
	.byte ATTACK_EFFECT_POISON
	.byte ATTACK_EFFECT_PARALYZE
	.byte ATTACK_EFFECT_LEECH_SEED
	.byte ATTACK_EFFECT_SPLASH
	.byte ATTACK_EFFECT_ATTACK_UP_2
	.byte ATTACK_EFFECT_ENCORE
	.byte ATTACK_EFFECT_CONVERSION_2
	.byte ATTACK_EFFECT_LOCK_ON
	.byte ATTACK_EFFECT_HEAL_BELL
	.byte ATTACK_EFFECT_MEAN_LOOK
	.byte ATTACK_EFFECT_NIGHTMARE
	.byte ATTACK_EFFECT_PROTECT
	.byte ATTACK_EFFECT_SKILL_SWAP
	.byte ATTACK_EFFECT_FORESIGHT
	.byte ATTACK_EFFECT_PERISH_SONG
	.byte ATTACK_EFFECT_SANDSTORM
	.byte ATTACK_EFFECT_ENDURE
	.byte ATTACK_EFFECT_SWAGGER
	.byte ATTACK_EFFECT_ATTRACT
	.byte ATTACK_EFFECT_SAFEGUARD
	.byte ATTACK_EFFECT_RAIN_DANCE
	.byte ATTACK_EFFECT_SUNNY_DAY
	.byte ATTACK_EFFECT_BELLY_DRUM
	.byte ATTACK_EFFECT_PSYCH_UP
	.byte ATTACK_EFFECT_FUTURE_SIGHT
	.byte ATTACK_EFFECT_FAKE_OUT
	.byte ATTACK_EFFECT_STOCKPILE
	.byte ATTACK_EFFECT_SPIT_UP
	.byte ATTACK_EFFECT_SWALLOW
	.byte ATTACK_EFFECT_HAIL
	.byte ATTACK_EFFECT_TORMENT
	.byte ATTACK_EFFECT_WILL_O_WISP
	.byte ATTACK_EFFECT_FOLLOW_ME
	.byte ATTACK_EFFECT_CHARGE
	.byte ATTACK_EFFECT_TRICK
	.byte ATTACK_EFFECT_ROLE_PLAY
	.byte ATTACK_EFFECT_INGRAIN
	.byte ATTACK_EFFECT_RECYCLE
	.byte ATTACK_EFFECT_KNOCK_OFF
	.byte ATTACK_EFFECT_SKILL_SWAP
	.byte ATTACK_EFFECT_IMPRISON
	.byte ATTACK_EFFECT_REFRESH
	.byte ATTACK_EFFECT_GRUDGE
	.byte ATTACK_EFFECT_TEETER_DANCE
	.byte ATTACK_EFFECT_MUD_SPORT
	.byte ATTACK_EFFECT_WATER_SPORT
	.byte ATTACK_EFFECT_DRAGON_DANCE
	.byte ATTACK_EFFECT_CAMOUFLAGE
	.byte -1
...
AI_CV_Protect: @ 81DB2E2
	...
	if_status AI_USER, STATUS1_BADLY_POISONED, AI_CV_Protect3
	...
	if_has_move_with_effect AI_TARGET, ATTACK_EFFECT_RESTORE_HP, AI_CV_Protect3
	if_has_move_with_effect AI_TARGET, ATTACK_EFFECT_DEFENSE_CURL, AI_CV_Protect3
	if_status AI_TARGET, STATUS1_BADLY_POISONED, AI_CV_Protect_ScoreUp2
	...
	get_last_used_move AI_TARGET
	get_move_effect_from_result
	if_not_equal ATTACK_EFFECT_LOCK_ON, AI_CV_Protect_ScoreUp2
	goto AI_CV_Protect2
...
AI_CV_Protect3: @ 81DB397
	get_last_used_move AI_TARGET
	get_move_effect_from_result
	if_not_equal ATTACK_EFFECT_LOCK_ON, AI_CV_Protect_End
...
AI_CV_ChargeUpMove: @ 81DB645
	...
	if_has_move_with_effect AI_TARGET, ATTACK_EFFECT_PROTECT, AI_CV_ChargeUpMove_ScoreDown2
...
AI_CV_SemiInvulnerable: @ 81DB669
	if_doesnt_have_move_with_effect AI_TARGET, ATTACK_EFFECT_PROTECT, AI_CV_SemiInvulnerable2
	score -1
...
AI_CV_SemiInvulnerable2: @ 81DB677
	if_status AI_TARGET, STATUS1_BADLY_POISONED, AI_CV_SemiInvulnerable_TryEncourage
...
AI_CV_SemiInvulnerable5: @ 81DB6D2
	...
	get_last_used_move AI_TARGET
	get_move_effect_from_result
	if_not_equal ATTACK_EFFECT_LOCK_ON, AI_CV_SemiInvulnerable_TryEncourage
	goto AI_CV_SemiInvulnerable_End
...
AI_CV_Facade: @ 81DB730
	if_not_status AI_USER, STATUS1_POISONED | STATUS1_BURNED | STATUS1_PARALYZED | STATUS1_BADLY_POISONED, AI_CV_Facade_End
	score +1
...
AI_CV_SmellingSalt: @ 81DB78C
	if_status AI_TARGET, STATUS1_PARALYZED, AI_CV_SmellingSalt_ScoreUp1
...
AI_CV_Snatch2: @ 81DB99B
	...
	if_has_move_with_effect AI_TARGET, ATTACK_EFFECT_RESTORE_HP, AI_CV_Snatch3
	if_has_move_with_effect AI_TARGET, ATTACK_EFFECT_DEFENSE_CURL, AI_CV_Snatch3
	goto AI_CV_Snatch4
...
AI_TryToFaint_TryToEncourageQuickAttack: @ 81DBA7C
	if_effect ATTACK_EFFECT_EXPLOSION, AI_TryToFaint_End
	if_not_effect ATTACK_EFFECT_QUICK_ATTACK, AI_TryToFaint_ScoreUp4
	score +2
...
AI_SetupFirstTurn_SetupEffectsToEncourage: @ 81DBAA7
	...
	.byte ATTACK_EFFECT_SPEED_UP
	.byte ATTACK_EFFECT_SPECIAL_ATTACK_UP
	.byte ATTACK_EFFECT_SPECIAL_DEFENSE_UP
	.byte ATTACK_EFFECT_ACCURACY_UP
	.byte ATTACK_EFFECT_EVASION_UP
	.byte ATTACK_EFFECT_ATTACK_DOWN
	.byte ATTACK_EFFECT_DEFENSE_DOWN
	.byte ATTACK_EFFECT_SPEED_DOWN
	.byte ATTACK_EFFECT_SPECIAL_ATTACK_DOWN
	.byte ATTACK_EFFECT_SPECIAL_DEFENSE_DOWN
	.byte ATTACK_EFFECT_ACCURACY_DOWN
	.byte ATTACK_EFFECT_EVASION_DOWN
	.byte ATTACK_EFFECT_CONVERSION
	.byte ATTACK_EFFECT_LIGHT_SCREEN
	.byte ATTACK_EFFECT_SPECIAL_DEFENSE_UP_2
	.byte ATTACK_EFFECT_FOCUS_ENERGY
	.byte ATTACK_EFFECT_CONFUSE
	.byte ATTACK_EFFECT_ATTACK_UP_2
	.byte ATTACK_EFFECT_DEFENSE_UP_2
	.byte ATTACK_EFFECT_SPEED_UP_2
	.byte ATTACK_EFFECT_SPECIAL_ATTACK_UP_2
	.byte ATTACK_EFFECT_SPECIAL_DEFENSE_UP_2
	.byte ATTACK_EFFECT_ACCURACY_UP_2
	.byte ATTACK_EFFECT_EVASION_UP_2
	.byte ATTACK_EFFECT_ATTACK_DOWN_2
	.byte ATTACK_EFFECT_DEFENSE_DOWN_2
	.byte ATTACK_EFFECT_SPEED_DOWN_2
	.byte ATTACK_EFFECT_SPECIAL_ATTACK_DOWN_2
	.byte ATTACK_EFFECT_SPECIAL_DEFENSE_DOWN_2
	.byte ATTACK_EFFECT_ACCURACY_DOWN_2
	.byte ATTACK_EFFECT_EVASION_DOWN_2
	.byte ATTACK_EFFECT_REFLECT
	.byte ATTACK_EFFECT_POISON
	.byte ATTACK_EFFECT_PARALYZE
	.byte ATTACK_EFFECT_SUBSTITUTE
	.byte ATTACK_EFFECT_LEECH_SEED
	.byte ATTACK_EFFECT_MINIMIZE
	.byte ATTACK_EFFECT_CURSE
	.byte ATTACK_EFFECT_SWAGGER
	.byte ATTACK_EFFECT_CAMOUFLAGE
	.byte ATTACK_EFFECT_YAWN
	.byte ATTACK_EFFECT_DEFENSE_CURL
	.byte ATTACK_EFFECT_TORMENT
	.byte ATTACK_EFFECT_FLATTER
	.byte ATTACK_EFFECT_WILL_O_WISP
	.byte ATTACK_EFFECT_INGRAIN
	.byte ATTACK_EFFECT_IMPRISON
	.byte ATTACK_EFFECT_TEETER_DANCE
	.byte ATTACK_EFFECT_TICKLE
	.byte ATTACK_EFFECT_COSMIC_POWER
	.byte ATTACK_EFFECT_BULK_UP
	.byte ATTACK_EFFECT_CALM_MIND
	.byte ATTACK_EFFECT_CAMOUFLAGE
	.byte -1
...
AI_Risky_EffectsToEncourage: @ 81DBB02
	.byte ATTACK_EFFECT_SLEEP
	.byte ATTACK_EFFECT_EXPLOSION
	.byte ATTACK_EFFECT_MIRROR_MOVE
	.byte ATTACK_EFFECT_OHKO
	.byte ATTACK_EFFECT_HIGH_CRITICAL
	.byte ATTACK_EFFECT_CONFUSE
	.byte ATTACK_EFFECT_METRONOME
	.byte ATTACK_EFFECT_PSYWAVE
	.byte ATTACK_EFFECT_COUNTER
	.byte ATTACK_EFFECT_DESTINY_BOND
	.byte ATTACK_EFFECT_SWAGGER
	.byte ATTACK_EFFECT_ATTRACT
	.byte ATTACK_EFFECT_PRESENT
	.byte ATTACK_EFFECT_ALL_STATS_UP_HIT
	.byte ATTACK_EFFECT_BELLY_DRUM
	.byte ATTACK_EFFECT_MIRROR_COAT
	.byte ATTACK_EFFECT_FOCUS_PUNCH
	.byte ATTACK_EFFECT_REVENGE
	.byte ATTACK_EFFECT_TEETER_DANCE
	.byte -1
...
AI_PreferBatonPass: @ 81DBB16
	...
	if_has_move_with_effect AI_USER, ATTACK_EFFECT_BATON_PASS, AI_PreferBatonPass_GoForBatonPass
...
AI_PreferBatonPass_GoForBatonPass: @ 81DBB32
	...
	if_effect ATTACK_EFFECT_PROTECT, AI_PreferBatonPass3
...
AI_HPAware_DiscouragedEffectsWhenHighHP: @ 81DBBC3
	.byte ATTACK_EFFECT_EXPLOSION
	.byte ATTACK_EFFECT_RESTORE_HP
	.byte ATTACK_EFFECT_REST
	.byte ATTACK_EFFECT_DESTINY_BOND
	.byte ATTACK_EFFECT_FLAIL
	.byte ATTACK_EFFECT_ENDURE
	.byte ATTACK_EFFECT_MORNING_SUN
	.byte ATTACK_EFFECT_SYNTHESIS
	.byte ATTACK_EFFECT_MOONLIGHT
	.byte ATTACK_EFFECT_SOFTBOILED
	.byte ATTACK_EFFECT_MEMENTO
	.byte ATTACK_EFFECT_GRUDGE
	.byte ATTACK_EFFECT_OVERHEAT
	.byte -1
...
AI_HPAware_DiscouragedEffectsWhenMediumHP: @ 81DBBD1
	...
	.byte ATTACK_EFFECT_ACCURACY_DOWN
	.byte ATTACK_EFFECT_EVASION_DOWN
	.byte ATTACK_EFFECT_BIDE
	.byte ATTACK_EFFECT_CONVERSION
	.byte ATTACK_EFFECT_LIGHT_SCREEN
	.byte ATTACK_EFFECT_MIST
	.byte ATTACK_EFFECT_FOCUS_ENERGY
	.byte ATTACK_EFFECT_ATTACK_UP_2
	.byte ATTACK_EFFECT_DEFENSE_UP_2
	.byte ATTACK_EFFECT_SPEED_UP_2
...
AI_HPAware_DiscouragedEffectsWhenLowHP: @ 81DBBFC
	...
	.byte ATTACK_EFFECT_PSYCH_UP
	.byte ATTACK_EFFECT_MIRROR_COAT
	.byte ATTACK_EFFECT_SOLARBEAM
	.byte ATTACK_EFFECT_ERUPTION
	.byte ATTACK_EFFECT_TICKLE
	.byte ATTACK_EFFECT_COSMIC_POWER
	.byte ATTACK_EFFECT_BULK_UP
	.byte ATTACK_EFFECT_CALM_MIND
...
AI_HPAware_DiscouragedEffectsWhenTargetLowHP: @ 81DBC55
	...
	.byte ATTACK_EFFECT_LIGHT_SCREEN
	.byte ATTACK_EFFECT_OHKO
	.byte ATTACK_EFFECT_SUPER_FANG  @ Maybe supposed to be ATTACK_EFFECT_RAZOR_WIND
	.byte ATTACK_EFFECT_SUPER_FANG
	.byte ATTACK_EFFECT_MIST
	.byte ATTACK_EFFECT_FOCUS_ENERGY
	.byte ATTACK_EFFECT_CONFUSE
	...
	.byte ATTACK_EFFECT_CONVERSION_2
	.byte ATTACK_EFFECT_LOCK_ON
	.byte ATTACK_EFFECT_SPITE
	.byte ATTACK_EFFECT_PERISH_SONG
	.byte ATTACK_EFFECT_SWAGGER
	.byte ATTACK_EFFECT_FURY_CUTTER
	.byte ATTACK_EFFECT_ATTRACT
	.byte ATTACK_EFFECT_SAFEGUARD
	.byte ATTACK_EFFECT_PSYCH_UP
	.byte ATTACK_EFFECT_MIRROR_COAT
...
AI_Unknown: @ 81DBC91
	if_not_effect ATTACK_EFFECT_SUNNY_DAY, AI_Unknown_End
