...
battle_bg battle_bgs[256] = {
    ...
    [BATTLE_BG_HAWEILAND] = {gfx_battle_bg_haweilandTiles, gfx_battle_bg_haweilandMap, NULL, NULL, gfx_battle_bg_haweilandPal},
    ...
    [BATTLE_BG_CARGO_HALL] = {gfx_battle_bg_cargo_hallTiles, gfx_battle_bg_cargo_hallMap, NULL, NULL, gfx_battle_bg_cargo_hallPal},
