...
.elseif LANG_EN
str_river_puzzle_help:
	.autostring 34 2 "Bring all Pokémon from the western to the eastern shore.\pThe boat holds space for two Pokémon.\pAny Baby-Pokémon is afraid if its nearby adult Pokémon. Thus, ensure that either any Baby-Pokémon is right by its parent's side or only other Baby-Pokémon are nearby.PAUSE_UNTIL_PRESS"
str_river_puzzle_confirm_exit:
