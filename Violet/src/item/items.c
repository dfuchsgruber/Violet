...
item items[] = {
	{
		...
		//ITEM_SENGONIT
		LANGDEP(PSTRING("Sengonit"), PSTRING("Zangoosenite")),
		ITEM_SENGONIT, //index
		0, //price
		0, //holding_effect_id
		0, //holding_effect_param
		str_item_sengonit_description,
		0, // Importance
		0, // exits_bag_on_use
		POCKET_ITEMS, //pocket
		4, //type
		...
		//ITEM_VIPITISNIT
		LANGDEP(PSTRING("Vipitisnit"), PSTRING("Sevipernite")),
		0xe8, //ITEM_VIPITISNIT
		0, //price
		0, //holding_effect_id
		0, //holding_effect_param
		str_item_vipitisnit_description,
		0, // Importance
		0, // exits_bag_on_use
		POCKET_ITEMS, //pocket
		4, //type
