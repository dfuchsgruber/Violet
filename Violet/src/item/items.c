...
item items[] = {
    ...
    },
    {
        ...
        ITEM_SANDAMERNIT, //index
        0,                //price
        0,                //holding_effect_id
        0,                //holding_effect_param
        str_item_sandamernit_description,
        0,                       // Importance
        0,                       // exits_bag_on_use
        POCKET_ITEMS,            //pocket
        4,                       //type
    ...
    },
    {
        ...
        0,   //holding_effect_id
        0,   //holding_effect_param
        str_item_maskeregenit_description,
        0,                       // Importance
        0,                       // exits_bag_on_use
        POCKET_ITEMS,            //pocket
        4,                       //type
    ...
    [ITEM_NORMALJUWEL] = {
        ...
        .index = 0x178,
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_NORMAL,
        .description = str_normaljuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
    ...
    [ITEM_KAMPFJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_KAMPF,
        .description = str_kampfjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_FLUGJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_FLUG,
        .description = str_flugjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_GIFTJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_GIFT,
        .description = str_giftjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_BODENJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_BODEN,
        .description = str_bodenjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_GESTEINJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_GESTEIN,
        .description = str_gesteinjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_KAEFERJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_KAEFER,
        .description = str_kaeferjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_GEISTJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_GEIST,
        .description = str_geistjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_STAHLJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_STAHL,
        .description = str_stahljuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_FEEJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_FEE,
        .description = str_feejuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_FEUERJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_FEUER,
        .description = str_feuerjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_WASSERJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_WASSER,
        .description = str_wasserjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_PFLANZEJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_PFLANZE,
        .description = str_pflanzejuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_ELEKTROJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_ELEKTRO,
        .description = str_elektrojuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_PSYCHOJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_PSYCHO,
        .description = str_psychojuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_EISJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_EIS,
        .description = str_eisjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_DRACOJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_DRACHE,
        .description = str_drachejuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_UNLICHTJUWEL] = {
        ...
        .price = 200,
        .holding_effect_id = HOLD_EFFECT_GEM,
        .holding_effect_param = TYPE_UNLICHT,
        .description = str_unlichtjuwel_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_LUNARSTUECK] = {
        ...
        .index = 0x18a,
        .price = 200,
        .description = str_item_lunarstueck_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_SOLARSTUECK] = {
        ...
        .index = 0x18b,
        .price = 200,
        .description = str_item_solarstueck_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_DUESTERSTUECK] = {
        ...
        .index = 0x18c,
        .price = 200,
        .description = str_item_duesterstueck_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_GLITZERSTUECK] = {
        ...
        .index = 0x18d,
        .price = 200,
        .description = str_item_glitzerstueck_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_LICHTSTUECK] = {
        ...
        .index = 0x18e,
        .price = 200,
        .description = str_item_lichtstueck_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_MININUGGET] = {
        ...
        .index = ITEM_MININUGGET,
        .price = 1000,
        .description = str_item_mininugget_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_QUARZSTAUB] = {
        ...
        .index = ITEM_QUARZSTAUB,
        .price = 50,
        .description = str_item_quarzstaub_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_ENERGIEQUARZ] = {
        ...
        .index = ITEM_ENERGIEQUARZ,
        .price = 1000,
        .description = str_item_energiequarz_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .field_usage = (void (*)(u8))0x80a2325,
    ...
    [ITEM_MULCH] = {
        ...
        .index = ITEM_MULCH,
        .price = 100,
        .description = str_item_mulch_description,
        .pocket = POCKET_ITEMS,
        .type = 2,
    ...
    [ITEM_WUESTEN_EI] = {
        ...
        .index = ITEM_WUESTEN_EI,
        .price = 100,
        .description = str_item_wuesten_ei_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_WEATHER_EGG,
        .holding_effect_param = WEATHER_ROCK_SANDSTORM,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_TUNDRA_EI] = {
        .name = LANGDEP(PSTRING("Blizzard-Ei"), PSTRING("Blizzard-Egg")),
        .index = ITEM_TUNDRA_EI,
        .price = 100,
        .description = str_item_tundra_ei_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_WEATHER_EGG,
        .holding_effect_param = WEATHER_ROCK_HAIL,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_GEWITTER_EI] = {
        ...
        .index = ITEM_TUNDRA_EI,
        .price = 100,
        .description = str_item_gewitter_ei_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_WEATHER_EGG,
        .holding_effect_param = WEATHER_ROCK_RAIN,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_SONNEN_EI] = {
        .name = LANGDEP(PSTRING("Sonnen-Ei"), PSTRING("Sun-Egg")),
        .index = ITEM_SONNEN_EI,
        .price = 100,
        .description = str_item_sonnen_ei_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_WEATHER_EGG,
        .holding_effect_param = WEATHER_ROCK_SUN,
        .field_usage = (void (*)(u8))0x80a2325,
    },
    [ITEM_ENERGIEDISK] = {
        .name = LANGDEP(PSTRING("Energiedisk"), PSTRING("Energy Disc")),
        .index = ITEM_ENERGIEDISK,
        .price = 1000,
        .description = str_item_energiedisc_description,
        .pocket = POCKET_ITEMS,
        .type = 2,
    ...
    [ITEM_BEULENHELM] = {
        ...
        .index = ITEM_BEULENHELM,
        .price = 200,
        .description = str_item_beulenhelm_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_BEULENHELM,
        .holding_effect_param = 6,
    },
    [ITEM_EXPERTENGURT] = {
        .name = LANGDEP(PSTRING("Expertengurt"), PSTRING("Expert Belt")),
        .index = ITEM_EXPERTENGURT,
        .price = 200,
        .description = str_item_expertengurt_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_EXPERT_BELT,
        .holding_effect_param = 20,
    },
    [ITEM_ENERGIEKRAUT] = {
        .name = LANGDEP(PSTRING("Energiekraut"), PSTRING("Power Herb")),
        .index = ITEM_ENERGIEKRAUT,
        .price = 200,
        .description = str_item_energiekraut_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
    ...
    [ITEM_FOKUSGURT] = {
        ...
        .index = ITEM_FOKUSGURT,
        .price = 200,
        .description = str_item_fokusgurt_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
    ...
    [ITEM_GROSSLINSE] = {
        ...
        .index = ITEM_GROSSLINSE,
        .price = 200,
        .description = str_item_grosslinse_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_BOOST_ACCURACY,
        .holding_effect_param = 20,
    },
    [ITEM_GIFTSCHLEIM] = {
        .name = LANGDEP(PSTRING("Giftschleim"), PSTRING("Black Sludge")),
        .index = ITEM_GIFTSCHLEIM,
        .price = 200,
        .description = str_item_giftschleim_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_RECOVERS_HP_AT_END_OF_TURN_FOR_TYPE,
        .holding_effect_param = TYPE_GIFT,
    },
    [ITEM_MUSKELBAND] = {
        .name = LANGDEP(PSTRING("Muskelband"), PSTRING("Muscle Band")),
        .index = ITEM_MUSKELBAND,
        .price = 200,
        .description = str_item_muskelband_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_BOOST_PHYSICAL_MOVES,
        .holding_effect_param = 10,
    },
    [ITEM_SCHLAUBRILLE] = {
        .name = LANGDEP(PSTRING("Schlaubrille"), PSTRING("Wise Glasses")),
        .index = ITEM_SCHLAUBRILLE,
        .price = 200,
        .description = str_item_schlaubrille_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_BOOST_SPECIAL_MOVES,
        .holding_effect_param = 10,
    },
    [ITEM_HEISS_ORB] = {
        .name = LANGDEP(PSTRING("Heiß-Orb"), PSTRING("Flame Orb")),
        .index = ITEM_HEISS_ORB,
        .price = 200,
        .description = str_item_heiss_orb_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_CAUSES_BURN,
        .holding_effect_param = 100,
    },
    [ITEM_TOXIK_ORB] = {
        .name = LANGDEP(PSTRING("Toxik-Orb"), PSTRING("Toxic Orb")),
        .index = ITEM_TOXIK_ORB,
        .price = 200,
        .description = str_item_toxik_orb_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
        .holding_effect_id = HOLD_EFFECT_CAUSES_POISON,
        .holding_effect_param = 100,
    },
    [ITEM_OFFENSIVWESTE] = {
        .name = LANGDEP(PSTRING("Offensivweste"), PSTRING("Assault Vest")),
        .index = ITEM_OFFENSIVWESTE,
        .price = 200,
        .description = str_item_offensivweste_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
    ...
    [ITEM_SCHWAECHENSCHUTZ] = {
        ...
        .index = ITEM_SCHWAECHENSCHUTZ,
        .price = 200,
        .description = str_item_schwaechenschutz_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
    ...
    [ITEM_KLAMMERBAND] = {
        ...
        .index = ITEM_KLAMMERBAND,
        .price = 200,
        .description = str_item_klammerband_description,
        .pocket = POCKET_ITEMS,
        .type = 4,
    ...
    [ITEM_LOTUS_BALL] = {
        ...
        .index = ITEM_LOTUS_BALL,
        .price = 1000,
        .description = str_item_lotus_ball_description,
        .pocket = POCKET_POKEBALLS,
        .type = 0,
        .battle_effect = 2,
        .battle_usage = item_pokeball_battle,
    },
    [ITEM_FLOTTBALL] = {
        .name = LANGDEP(PSTRING("Flottball"), PSTRING("Quick Ball")),
        .index = ITEM_FLOTTBALL,
        .price = 1000,
        .description = str_item_flottball_description,
        .pocket = POCKET_POKEBALLS,
        .type = 0,
        .battle_effect = 2,
        .battle_usage = item_pokeball_battle,
    ...
    [ITEM_FINSTERBALL] = {
        ...
        .index = ITEM_FINSTERBALL,
        .price = 1000,
        .description = str_item_duesterball_description,
        .pocket = POCKET_POKEBALLS,
        .type = 0,
        .battle_effect = 2,
        .battle_usage = item_pokeball_battle,
