...
static item_gfx_pair item_gfx_pairs[] = {
    ...
    [ITEM_ITEM_58 ] = { .gfx = gfx_item_item_58Tiles, .pal = gfx_item_item_58Pal },
    ...
    [ITEM_79] = { .gfx = gfx_item_79Tiles, .pal = gfx_item_79Pal },
    ...
    [ITEM_ITEM_10B] = { .gfx = gfx_item_item_10bTiles, .pal = gfx_item_item_10bPal },
    ...
    [ITEM_BLAUE_KUGEL] = { .gfx = gfx_item_blaue_kugelTiles, .pal = gfx_item_blaue_kugelPal },
    [ITEM_SCANNER] = { .gfx = gfx_item_scannerTiles, .pal = gfx_item_scannerPal },
    [ITEM_WUESTENGLAS] = { .gfx = gfx_item_wuestenglasTiles, .pal = gfx_item_wuestenglasPal },
    [ITEM_METEORIT] = { .gfx = gfx_item_meteoritTiles, .pal = gfx_item_meteoritPal },
