...
static color_t dns_color_light_yellow_weak_dark = {.rgb = {.red = 248 / 8, .green = 200 / 8, .blue = 112 / 8}};
static color_t dns_color_light_yellow_light = {.rgb = {.red = 248 / 8, .green = 232 / 8, .blue = 192 / 8}};
