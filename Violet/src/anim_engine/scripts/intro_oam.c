...
rotscale_frame rotscal_anim_intro_meteor[] = {
    {.affine = {0x200, 0x200, 0, 0, 0}}, {.affine = {-8, -8, 0, 63, 0}}, {.command = {ROTSCALE_ANIM_END, 0, 0, 0}}};
...
gfx_frame gfx_anim_intro_deoxys_arm_right[] = {
    {0, 16}, {32, 16}, {64, 16}, {32, 16}, {0xFFFE, 0}};

gfx_frame gfx_anim_intro_deoxys_arm_left[] = {
    {0, 16 | GFX_ANIM_HFLIP}, {32, 16 | GFX_ANIM_HFLIP}, {64, 16 | GFX_ANIM_HFLIP}, {32, 16 | GFX_ANIM_HFLIP}, {GFX_ANIM_JUMP, 0}};
...
void oam_intro_waves_front_move(oam_object *self) {
    if (++(self->private[0]) == 3) {
        ...
        if (self->x + self->x2 == 256 + 64)
            self->x2 = (s16)(-64 - self->x);
    }
}
