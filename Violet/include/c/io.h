...
#define IO_BLDCNT_FIRST_ALL (IO_BLDCNT_BG0_FIRST | IO_BLDCNT_BG1_FIRST | IO_BLDCNT_BG2_FIRST | IO_BLDCNT_BG3_FIRST | IO_BLDCNT_OBJ_FIRST | IO_BLDCNT_BACKDROP_FIRST) 
#define IO_BLDCNT_SECOND_ALL (IO_BLDCNT_BG0_SECOND | IO_BLDCNT_BG1_SECOND | IO_BLDCNT_BG2_SECOND | IO_BLDCNT_BG3_SECOND | IO_BLDCNT_OBJ_SECOND | IO_BLDCNT_BACKDROP_SECOND)
