...
trainer_pokemon_custom_item_custom_attacks trainer_party_x1cb_bluetenbach_gym_manus_easy[4];
trainer_pokemon_custom_item_custom_attacks trainer_party_x1cc_bluetenbach_gym_manus_hard[6];
trainer_pokemon_custom_item_custom_attacks trainer_party_xb8[5];
