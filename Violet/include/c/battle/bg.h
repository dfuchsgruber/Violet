...
extern const unsigned short gfx_battle_bg_pokestop_restaurantTiles[];
...
extern const unsigned short gfx_battle_bg_pokestop_restaurantPal[];
...
extern const unsigned short gfx_battle_bg_pokestop_restaurantMap[];
