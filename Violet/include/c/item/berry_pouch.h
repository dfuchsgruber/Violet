...
enum {
    BERRY_POUCH_FROMFIELD,
    BERRY_POUCH_FROMPARTYGIVE,
    BERRY_POUCH_FROMMARTSELL,
    BERRY_POUCH_FROMPOKEMONSTORAGEPC,
    BERRY_POUCH_FROMBATTLE,
    BERRY_POUCH_FROMBERRYCRUSH,
    BERRY_POUCH_NA,
    BERRY_POUCH_COMPOSTER,
};
