...
#define INCLUDE_C_POKEPAD_WONDERTRADE_H_
    ...
    enum {
        POKEPAD_WONDERTRADE_GFX_TAG_BADGE = 0xA004,
        POKEPAD_WONDERTRADE_GFX_TAG_PROGRESS_BAR,
    };

    enum {
        POKEPAD_WONDERTRADE_TBOX_TITLE,
        POKEPAD_WONDERTRADE_TBOX_LEVEL,
        POKEPAD_WONDERTRADE_TBOX_CNT,
        POKEPAD_WONDERTRADE_TBOX_NEXT,
        POKEPAD_WONDERTRADE_TBOX_RENDERER,
        POKEPAD_WONDERTRADE_TBOX_TRADE,
        POKEPAD_WONDERTRADE_TBOX_BACK,
        POKEPAD_WONDERTRADE_NUM_TBOXES,
    };
    ...
    enum {
        ...
        WONDERTRADE_LEVEL_PLATINUM,
        NUM_WONDERTRADE_LEVELS,
    };
