...
static trainer_pokemon_custom_item_custom_attacks trainer_party_x1ff_tafelberg_clouds_ancient_guard_blue[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, TRAINER_BUILD_SPECIAL_TANK, 0x0, false, false, 40, 
		POKEMON_LEPUMENTAS, ITEM_LICHTLEHM, ATTACK_REFLEKTOR, ATTACK_LICHTSCHILD, ATTACK_PSYCHOKINESE, ATTACK_ERDKRAEFTE),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, TRAINER_BUILD_SPECIAL_SWEEPER_SPECIAL_ATTACK_PREFERENCE, 0x0, false, false, 40, 
		POKEMON_SAGANABYSS, ITEM_GEWITTER_EI, ATTACK_HYDROPUMPE, ATTACK_EISSTRAHL, ATTACK_REGENTANZ, ATTACK_PSYCHOKINESE),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, TRAINER_BUILD_SPECIAL_TANK, 0x0, false, false, 40, 
		POKEMON_AMOROSO, ITEM_UEBERRESTE, ATTACK_WHIRLPOOL, ATTACK_TOXIN, ATTACK_SCHUTZSCHILD, ATTACK_TAUCHER),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0, TRAINER_BUILD_PHYSICAL_WALL_ATTACK_PREFERENCE, 0x0, false, false, 40, 
		POKEMON_KABUTOPS, ITEM_FOKUSGURT, ATTACK_KASKADE, ATTACK_SCHWERTTANZ, ATTACK_WASSERDUESE, ATTACK_STEINKANTE),
