...
u16 dungeon_ocean_wild_pokemon_common[] = {
    POKEMON_SANDAN,
    POKEMON_ZUBAT,
    POKEMON_DIGDA,
    POKEMON_MACHOLLO,
...
u16 dungeon_ocean_wild_pokemon_rare[] = {
    POKEMON_SONNFEL,
    POKEMON_LUNASTEIN,
    POKEMON_SANDAMER,
    POKEMON_GEOROK,
...
u16 dungeon_ocean_wild_pokemon_super_rare[] = {
    POKEMON_STOLLRAK,
    POKEMON_ZOBIRIS,
    POKEMON_LARVITAR,
    POKEMON_MASCHOCK,
...
void dungeon2_init_wild_pokemon_ocean(dungeon_generator2 *dg2) {
  ...
  dungeon2_pick_wild_pokemon(common_pokemon, 4, dungeon_ocean_wild_pokemon_common, dg2);
  // Pick one rare pokemon
  u16 rare_pokemon[2];
  dungeon2_pick_wild_pokemon(rare_pokemon, 2, dungeon_ocean_wild_pokemon_rare, dg2);
  // Pick one super rare pokemon
  u16 super_rare_pokemon[1];
  dungeon2_pick_wild_pokemon(super_rare_pokemon, 1, dungeon_ocean_wild_pokemon_super_rare, dg2);
  ...
  *var_access(DUNGEON_OVERWORLD_SPECIES) = super_rare_pokemon[0];
  ...
  fmem->dwild_habitat_grass.frequency = DTYPE_OCEAN_WILD_POKEMON_FREQUENCY;
