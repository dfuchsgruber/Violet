...
void lz77uncompvram (u32*source, u32*destination);
void lz77uncompwram (u32*source, u32*destination);
void cb1handling();
void bg_copy_vram(u8 bgid, u32*source, u16 size, u16 starttile, u8 mode);
void cpuset (u32*source, u32*destination, u32 cnt_and_mode);
...
u32 get_pokemons_attribute (void*pokemon_offset, u16 requested_attribute, void*freespace);
