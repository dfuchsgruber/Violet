...
.ifdef LANG_GER
	...
	str_ability_descr_0x65:
		.string "Absorbiert zugef. Schaden."


	.global str_ability_descr_0x66

	str_ability_descr_0x66:
		.string "Erträgt eff. Att. besser."
