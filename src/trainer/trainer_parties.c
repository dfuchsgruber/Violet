...
trainer_pokemon_custom_item_custom_attacks trainer_party_xb7[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0x1, 0x0, false, false, 24, POKEMON_KAPILZ, ITEM_NONE, ATTACK_TEMPOHIEB, ATTACK_PILZSPORE, ATTACK_KOPFNUSS, ATTACK_SAMENBOMBEN),
...
trainer_pokemon_custom_item_custom_attacks trainer_party_xbe[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0x1, 0x0, false, false, 38, POKEMON_STAHLSTICH, ITEM_TSITRUBEERE, ATTACK_SAMENBOMBEN, ATTACK_STAHLSTREICH, ATTACK_SCHLITZER, ATTACK_SCHWERTTANZ),
