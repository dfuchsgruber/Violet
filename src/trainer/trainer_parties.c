...
trainer_pokemon_custom_item_custom_attacks trainer_party_x4c[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x1,0x0,false,false,26,POKEMON_GARADOS,ITEM_TSITRUBEERE,ATTACK_DRACHENTANZ,ATTACK_BISS,ATTACK_NASSSCHWEIF,ATTACK_EISZAHN),
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x1,0x0,false,false,28,POKEMON_VIPITIS,ITEM_PRUNUSBEERE,ATTACK_GIFTSCHWEIF,ATTACK_EISENSCHWEIF,ATTACK_NACHTHIEB,ATTACK_NASSSCHWEIF)
};
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x5c[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x0,0x0,false,false,30,POKEMON_SEESKULL,ITEM_TSITRUBEERE,ATTACK_DRACHENTANZ,ATTACK_NASSSCHWEIF,ATTACK_EISENSCHWEIF,ATTACK_GIFTSCHWEIF),
...
trainer_pokemon_custom_item_custom_attacks trainer_party_x14c[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(0x1,0x0,false,false,35,POKEMON_AZUMARILL,ITEM_NONE,ATTACK_KNUDDLER,ATTACK_NASSSCHWEIF,ATTACK_KRAFTKOLOSS,ATTACK_EISHIEB),
