...
trainer_pokemon_custom_item_custom_attacks trainer_party_xb8[] = {
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0x0, 0x0, false, false, 35, POKEMON_MACHOMEI, ITEM_SCHWARZGURT, ATTACK_WUCHTSCHLAG, ATTACK_STEINKANTE, ATTACK_ERDBEBEN, ATTACK_DONNERSCHLAG),
...
trainer_pokemon_custom_item_custom_attacks trainer_party_xb9[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0x7, 0x0, false, false, 20, POKEMON_BISAKNOSP, ITEM_NONE, ATTACK_SCHLAFPUDER, ATTACK_EGELSAMEN, ATTACK_SAEURE, ATTACK_ENERGIEBALL),
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0x2, 0x0, false, false, 20, POKEMON_KAUMALAT, ITEM_NONE, ATTACK_DRACHENWUT, ATTACK_SCHAUFLER, ATTACK_KRATZER, ATTACK_BODYCHECK)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xba[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0x1, 0x0, false, false, 20, POKEMON_GLUTEXO, ITEM_NONE, ATTACK_METALLKLAUE, ATTACK_FEUERSCHLAG, ATTACK_DRACHENTANZ, ATTACK_STEINHAGEL),
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0xb, 0x0, false, false, 20, POKEMON_KINDWURM, ITEM_NONE, ATTACK_GLUT, ATTACK_TACKLE, ATTACK_KOPFNUSS, ATTACK_DRACHENKLAUE)
};

trainer_pokemon_custom_item_custom_attacks trainer_party_xbb[] = {
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0x5, 0x0, false, false, 20, POKEMON_SCHILLOK, ITEM_NONE, ATTACK_AQUAWELLE, ATTACK_AURORASTRAHL, ATTACK_AURASPHAERE, ATTACK_NONE),
	...
	TRAINER_PARTY_CUSTOM_ITEM_CUSTOM_MOVES(31, 0xd, 0x0, false, false, 19, POKEMON_DRATINI, ITEM_NONE, ATTACK_DONNERWELLE, ATTACK_DRACHENWUT, ATTACK_WINDHOSE, ATTACK_SURFER)
};
